...
80100028:	bc 90 73 11 80       	mov    $0x80117390,%esp
...
80100271:	68 06 78 10 80       	push   $0x80107806
...
801003b0:	e8 fb 02 00 00       	call   801006b0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 90 7c 10 80 	movl   $0x80107c90,(%esp)
...
8010041f:	e8 fc 5e 00 00       	call   80106320 <uartputc>
...
801004ea:	e8 31 5e 00 00       	call   80106320 <uartputc>
801004ef:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
801004f6:	e8 25 5e 00 00       	call   80106320 <uartputc>
801004fb:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
80100502:	e8 19 5e 00 00       	call   80106320 <uartputc>
...
801005a3:	68 25 78 10 80       	push   $0x80107825
...
80100838:	b9 28 00 00 00       	mov    $0x28,%ecx
        s = "(null)";
8010083d:	bf 38 78 10 80       	mov    $0x80107838,%edi
...
8010088c:	68 3f 78 10 80       	push   $0x8010783f
...
801008b3:	e8 48 3e 00 00       	call   80104700 <acquire>
  while((c = getc()) >= 0){
...
80100a2c:	e8 4f 37 00 00       	call   80104180 <wakeup>
...
80100a4f:	e9 0c 38 00 00       	jmp    80104260 <procdump>
80100a54:	fa                   	cli
    for(;;)
...
80100b14:	0f 85 f1 00 00 00    	jne    80100c0b <exec+0x15b>
  ...
  if((pgdir = setupkvm()) == 0)
80100b1a:	e8 71 69 00 00       	call   80107490 <setupkvm>
...
80100b8b:	e8 30 67 00 00       	call   801072c0 <allocuvm>
...
80100bc1:	e8 2a 66 00 00       	call   801071f0 <loaduvm>
...
80100c03:	e8 08 68 00 00       	call   80107410 <freevm>
  if(ip){
...
80100c81:	31 f6                	xor    %esi,%esi
  clearpteu(pgdir, (char*)(sz - 2*PGSIZE));
80100c83:	e8 a8 68 00 00       	call   80107530 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100cca:	e8 01 41 00 00       	call   80104dd0 <strlen>
...
80100cd8:	83 e3 fc             	and    $0xfffffffc,%ebx
    if(copyout(pgdir, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
80100cdb:	e8 f0 40 00 00       	call   80104dd0 <strlen>
...
80100cee:	e8 0d 6a 00 00       	call   80107700 <copyout>
...
80100d03:	e8 08 67 00 00       	call   80107410 <freevm>
...
80100d5f:	e8 9c 69 00 00       	call   80107700 <copyout>
...
80100d9f:	e8 ec 3f 00 00       	call   80104d90 <safestrcpy>
  curproc->pgdir = pgdir;
80100da4:	8b 8d f4 fe ff ff    	mov    -0x10c(%ebp),%ecx
  oldpgdir = curproc->pgdir;
80100daa:	89 f0                	mov    %esi,%eax
80100dac:	8b 76 08             	mov    0x8(%esi),%esi
  curproc->sz = sz;
80100daf:	89 78 04             	mov    %edi,0x4(%eax)
  curproc->pgdir = pgdir;
80100db2:	89 48 08             	mov    %ecx,0x8(%eax)
  curproc->tf->eip = elf.entry;  // main
80100db5:	89 c1                	mov    %eax,%ecx
80100db7:	8b 95 3c ff ff ff    	mov    -0xc4(%ebp),%edx
80100dbd:	8b 40 1c             	mov    0x1c(%eax),%eax
80100dc0:	89 50 38             	mov    %edx,0x38(%eax)
  curproc->tf->esp = sp;
80100dc3:	8b 41 1c             	mov    0x1c(%ecx),%eax
80100dc6:	89 58 44             	mov    %ebx,0x44(%eax)
  switchuvm(curproc);
80100dc9:	89 0c 24             	mov    %ecx,(%esp)
80100dcc:	e8 8f 62 00 00       	call   80107060 <switchuvm>
  freevm(oldpgdir);
80100dd1:	89 34 24             	mov    %esi,(%esp)
80100dd4:	e8 37 66 00 00       	call   80107410 <freevm>
  return 0;
...
80100e0e:	e9 16 ff ff ff       	jmp    80100d29 <exec+0x279>
    end_op();
80100e13:	e8 98 1f 00 00       	call   80102db0 <end_op>
    cprintf("exec: fail\n");
80100e18:	83 ec 0c             	sub    $0xc,%esp
80100e1b:	68 50 78 10 80       	push   $0x80107850
...
80100e36:	68 5c 78 10 80       	push   $0x8010785c
80100e3b:	68 60 ff 10 80       	push   $0x8010ff60
80100e40:	e8 cb 36 00 00       	call   80104510 <initlock>
}
...
80100e61:	e8 9a 38 00 00       	call   80104700 <acquire>
...
80100ecf:	e8 2c 38 00 00       	call   80104700 <acquire>
  if(f->ref < 1)
...
80100efb:	68 63 78 10 80       	push   $0x80107863
...
80100f21:	e8 da 37 00 00       	call   80104700 <acquire>
  if(f->ref < 1)
...
80100fdc:	68 6b 78 10 80       	push   $0x8010786b
...
801010c2:	68 75 78 10 80       	push   $0x80107875
...
80101197:	68 7e 78 10 80       	push   $0x8010787e
...
801011d1:	68 84 78 10 80       	push   $0x80107884
...
80101289:	68 8e 78 10 80       	push   $0x8010788e
...
801012cd:	e8 0e 39 00 00       	call   80104be0 <memset>
  log_write(bp);
...
8010130a:	e8 f1 33 00 00       	call   80104700 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
801013d8:	68 a4 78 10 80       	push   $0x801078a4
...
80101457:	68 b4 78 10 80       	push   $0x801078b4
...
80101535:	68 c7 78 10 80       	push   $0x801078c7
...
80101561:	e8 0a 37 00 00       	call   80104c70 <memmove>
  brelse(bp);
...
8010158c:	68 da 78 10 80       	push   $0x801078da
80101591:	68 60 09 11 80       	push   $0x80110960
80101596:	e8 75 2f 00 00       	call   80104510 <initlock>
  for(i = 0; i < NINODE; i++) {
8010159b:	83 c4 10             	add    $0x10,%esp
8010159e:	66 90                	xchg   %ax,%ax
    initsleeplock(&icache.inode[i].lock, "inode");
801015a0:	83 ec 08             	sub    $0x8,%esp
801015a3:	68 e1 78 10 80       	push   $0x801078e1
801015a8:	53                   	push   %ebx
  for(i = 0; i < NINODE; i++) {
801015a9:	81 c3 90 00 00 00    	add    $0x90,%ebx
    initsleeplock(&icache.inode[i].lock, "inode");
801015af:	e8 2c 2e 00 00       	call   801043e0 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801015dc:	e8 8f 36 00 00       	call   80104c70 <memmove>
  brelse(bp);
...
801016ae:	e8 2d 35 00 00       	call   80104be0 <memset>
      dip->type = type;
...
801016e3:	68 e7 78 10 80       	push   $0x801078e7
...
80101751:	e8 1a 35 00 00       	call   80104c70 <memmove>
  log_write(bp);
...
8010177f:	e8 7c 2f 00 00       	call   80104700 <acquire>
  ip->ref++;
80101784:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101788:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
8010178f:	e8 0c 2f 00 00       	call   801046a0 <release>
}
...
801017c2:	e8 59 2c 00 00       	call   80104420 <acquiresleep>
  if(ip->valid == 0){
...
80101838:	e8 33 34 00 00       	call   80104c70 <memmove>
    brelse(bp);
...
8010185d:	68 f9 78 10 80       	push   $0x801078f9
80101862:	e8 19 eb ff ff       	call   80100380 <panic>
    panic("ilock");
80101867:	83 ec 0c             	sub    $0xc,%esp
8010186a:	68 4c 7b 10 80       	push   $0x80107b4c
...
80101893:	e8 28 2c 00 00       	call   801044c0 <holdingsleep>
...
801018ae:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
801018af:	e9 cc 2b 00 00       	jmp    80104480 <releasesleep>
    panic("iunlock");
801018b4:	83 ec 0c             	sub    $0xc,%esp
801018b7:	68 08 79 10 80       	push   $0x80107908
...
801018e0:	e8 3b 2b 00 00       	call   80104420 <acquiresleep>
...
801018fa:	e8 81 2b 00 00       	call   80104480 <releasesleep>
  acquire(&icache.lock);
801018ff:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
80101906:	e8 f5 2d 00 00       	call   80104700 <acquire>
  ip->ref--;
...
80101a43:	e8 78 2a 00 00       	call   801044c0 <holdingsleep>
...
80101a5a:	e8 21 2a 00 00       	call   80104480 <releasesleep>
  iput(ip);
...
80101a73:	68 08 79 10 80       	push   $0x80107908
...
80101b57:	e8 14 31 00 00       	call   80104c70 <memmove>
    brelse(bp);
...
80101c55:	e8 16 30 00 00       	call   80104c70 <memmove>
    log_write(bp);
...
80101cde:	e8 fd 2f 00 00       	call   80104ce0 <strncmp>
}
80101ce3:	c9                   	leave
80101ce4:	c3                   	ret
...
80101d3d:	e8 9e 2f 00 00       	call   80104ce0 <strncmp>
      continue;
...
80101d82:	68 22 79 10 80       	push   $0x80107922
80101d87:	e8 f4 e5 ff ff       	call   80100380 <panic>
    panic("dirlookup not DIR");
80101d8c:	83 ec 0c             	sub    $0xc,%esp
80101d8f:	68 10 79 10 80       	push   $0x80107910
...
80101e37:	e8 34 2e 00 00       	call   80104c70 <memmove>
...
80101eeb:	e8 80 2d 00 00       	call   80104c70 <memmove>
    name[len] = 0;
...
80101f25:	e8 96 25 00 00       	call   801044c0 <holdingsleep>
...
80101f3c:	e8 3f 25 00 00       	call   80104480 <releasesleep>
  iput(ip);
...
80101f75:	e8 46 25 00 00       	call   801044c0 <holdingsleep>
...
80101f8c:	e8 ef 24 00 00       	call   80104480 <releasesleep>
}
...
80101fb1:	68 08 79 10 80       	push   $0x80107908
...
8010201d:	e8 0e 2d 00 00       	call   80104d30 <strncpy>
  de.inum = inum;
...
8010205b:	68 31 79 10 80       	push   $0x80107931
80102060:	e8 1b e3 ff ff       	call   80100380 <panic>
    panic("dirlink");
80102065:	83 ec 0c             	sub    $0xc,%esp
80102068:	68 94 7b 10 80       	push   $0x80107b94
...
8010217b:	68 47 79 10 80       	push   $0x80107947
80102180:	e8 fb e1 ff ff       	call   80100380 <panic>
    panic("idestart");
80102185:	83 ec 0c             	sub    $0xc,%esp
80102188:	68 3e 79 10 80       	push   $0x8010793e
...
801021a6:	68 59 79 10 80       	push   $0x80107959
801021ab:	68 00 26 11 80       	push   $0x80112600
801021b0:	e8 5b 23 00 00       	call   80104510 <initlock>
...
8010223e:	e8 bd 24 00 00       	call   80104700 <acquire>
...
8010229d:	e8 de 1e 00 00       	call   80104180 <wakeup>
...
801022bb:	e8 e0 23 00 00       	call   801046a0 <release>
...
801022de:	e8 dd 21 00 00       	call   801044c0 <holdingsleep>
...
80102318:	e8 e3 23 00 00       	call   80104700 <acquire>
...
80102359:	e8 62 1d 00 00       	call   801040c0 <sleep>
  while((b->flags & (B_VALID|B_DIRTY)) != B_VALID){
...
80102375:	c9                   	leave
  release(&idelock);
80102376:	e9 25 23 00 00       	jmp    801046a0 <release>
...
801024b2:	81 fb 90 73 11 80    	cmp    $0x80117390,%ebx
...
801024d2:	e8 09 27 00 00       	call   80104be0 <memset>
...
80102508:	e8 f3 21 00 00       	call   80104700 <acquire>
...
80102522:	c9                   	leave
    release(&kmem.lock);
80102523:	e9 78 21 00 00       	jmp    801046a0 <release>
    panic("kfree");
80102528:	83 ec 0c             	sub    $0xc,%esp
8010252b:	68 a6 79 10 80       	push   $0x801079a6
...
801025fb:	68 ac 79 10 80       	push   $0x801079ac
80102600:	68 40 26 11 80       	push   $0x80112640
80102605:	e8 06 1f 00 00       	call   80104510 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
80102698:	e8 63 20 00 00       	call   80104700 <acquire>
  r = kmem.freelist;
...
801026c3:	e8 d8 1f 00 00       	call   801046a0 <release>
}
...
8010271b:	0f b6 91 c0 7f 10 80 	movzbl -0x7fef8040(%ecx),%edx
  shift ^= togglecode[data];
80102722:	0f b6 81 c0 7e 10 80 	movzbl -0x7fef8140(%ecx),%eax
  shift |= shiftcode[data];
...
80102738:	83 e2 08             	and    $0x8,%edx
  c = charcode[shift & (CTL | SHIFT)][data];
8010273b:	8b 04 85 a0 7e 10 80 	mov    -0x7fef8160(,%eax,4),%eax
...
80102775:	0f 44 c8             	cmove  %eax,%ecx
    shift &= ~(shiftcode[data] | E0ESC);
80102778:	0f b6 81 c0 7f 10 80 	movzbl -0x7fef8040(%ecx),%eax
...
80102ad3:	e8 48 21 00 00       	call   80104c20 <memcmp>
...
80102c04:	e8 67 20 00 00       	call   80104c70 <memmove>
...
80102caa:	68 b1 79 10 80       	push   $0x801079b1
80102caf:	68 a0 26 11 80       	push   $0x801126a0
80102cb4:	e8 57 18 00 00       	call   80104510 <initlock>
  readsb(dev, &sb);
80102cb9:	58                   	pop    %eax
...
80102d4b:	e8 b0 19 00 00       	call   80104700 <acquire>
...
80102d65:	e8 56 13 00 00       	call   801040c0 <sleep>
...
80102d9c:	e8 ff 18 00 00       	call   801046a0 <release>
      break;
    }
  }
}
...
80102dbe:	e8 3d 19 00 00       	call   80104700 <acquire>
  log.outstanding -= 1;
...
80102dfc:	e8 9f 18 00 00       	call   801046a0 <release>
}
...
80102e94:	e8 d7 1d 00 00       	call   80104c70 <memmove>
...
80102ee8:	e8 93 12 00 00       	call   80104180 <wakeup>
  release(&log.lock);
80102eed:	c7 04 24 a0 26 11 80 	movl   $0x801126a0,(%esp)
80102ef4:	e8 a7 17 00 00       	call   801046a0 <release>
...
80102f07:	68 b5 79 10 80       	push   $0x801079b5
...
80102f98:	c9                   	leave
  release(&log.lock);
80102f99:	e9 02 17 00 00       	jmp    801046a0 <release>
...
80102fb5:	68 c4 79 10 80       	push   $0x801079c4
80102fba:	e8 c1 d3 ff ff       	call   80100380 <panic>
    panic("log_write outside of trans");
80102fbf:	83 ec 0c             	sub    $0xc,%esp
80102fc2:	68 da 79 10 80       	push   $0x801079da
...
80102fe8:	68 f5 79 10 80       	push   $0x801079f5
80102fed:	e8 be d6 ff ff       	call   801006b0 <cprintf>
  idtinit();       // load idt register
80102ff2:	e8 39 2f 00 00       	call   80105f30 <idtinit>
...
80103013:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80103016:	e8 35 40 00 00       	call   80107050 <switchkvm>
  seginit();
8010301b:	e8 a0 3f 00 00       	call   80106fc0 <seginit>
  lapicinit();
...
80103074:	e8 b7 31 00 00       	call   80106230 <uartinit>
  pinit();         // process table
80103079:	e8 72 08 00 00       	call   801038f0 <pinit>
  pi_init();
8010307e:	e8 1d 18 00 00       	call   801048a0 <pi_init>
  tvinit();        // trap vectors
80103083:	e8 28 2e 00 00       	call   80105eb0 <tvinit>
  binit();         // buffer cache
80103088:	e8 b3 cf ff ff       	call   80100040 <binit>
  fileinit();      // file table
8010308d:	e8 9e dd ff ff       	call   80100e30 <fileinit>
  ideinit();       // disk 
80103092:	e8 09 f1 ff ff       	call   801021a0 <ideinit>
...
8010309a:	68 8a 00 00 00       	push   $0x8a
8010309f:	68 8c b4 10 80       	push   $0x8010b48c
801030a4:	68 00 70 00 80       	push   $0x80007000
801030a9:	e8 c2 1b 00 00       	call   80104c70 <memmove>

  for(c = cpus; c < cpus+ncpu; c++){
801030ae:	83 c4 10             	add    $0x10,%esp
801030b1:	69 05 84 27 11 80 b0 	imul   $0xb0,0x80112784,%eax
801030b8:	00 00 00 
801030bb:	05 a0 27 11 80       	add    $0x801127a0,%eax
801030c0:	3d a0 27 11 80       	cmp    $0x801127a0,%eax
801030c5:	76 79                	jbe    80103140 <main+0x110>
801030c7:	bb a0 27 11 80       	mov    $0x801127a0,%ebx
801030cc:	eb 1b                	jmp    801030e9 <main+0xb9>
...
8010318e:	68 09 7a 10 80       	push   $0x80107a09
80103193:	56                   	push   %esi
80103194:	e8 87 1a 00 00       	call   80104c20 <memcmp>
...
80103249:	68 0e 7a 10 80       	push   $0x80107a0e
8010324e:	50                   	push   %eax
8010324f:	e8 cc 19 00 00       	call   80104c20 <memcmp>
...
8010337b:	68 13 7a 10 80       	push   $0x80107a13
...
801033a2:	68 09 7a 10 80       	push   $0x80107a09
801033a7:	53                   	push   %ebx
801033a8:	e8 73 18 00 00       	call   80104c20 <memcmp>
...
801033d8:	68 80 7d 10 80       	push   $0x80107d80
...
80103480:	00 00 00 
  initlock(&p->lock, "pipe");
80103483:	68 2b 7a 10 80       	push   $0x80107a2b
80103488:	50                   	push   %eax
80103489:	e8 82 10 00 00       	call   80104510 <initlock>
  (*f0)->type = FD_PIPE;
...
8010350f:	e8 ec 11 00 00       	call   80104700 <acquire>
  if(writable){
...
8010352f:	e8 4c 0c 00 00       	call   80104180 <wakeup>
...
80103553:	5d                   	pop    %ebp
    release(&p->lock);
80103554:	e9 47 11 00 00       	jmp    801046a0 <release>
80103559:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    release(&p->lock);
80103560:	83 ec 0c             	sub    $0xc,%esp
80103563:	53                   	push   %ebx
80103564:	e8 37 11 00 00       	call   801046a0 <release>
    kfree((char*)p);
...
80103594:	e8 e7 0b 00 00       	call   80104180 <wakeup>
...
801035b0:	e8 4b 11 00 00       	call   80104700 <acquire>
  for(i = 0; i < n; i++){
...
801035fb:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
      if(p->readopen == 0 || myproc()->killed){
80103600:	e8 8b 03 00 00       	call   80103990 <myproc>
...
80103610:	e8 6b 0b 00 00       	call   80104180 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
80103615:	58                   	pop    %eax
80103616:	5a                   	pop    %edx
80103617:	53                   	push   %ebx
80103618:	57                   	push   %edi
80103619:	e8 a2 0a 00 00       	call   801040c0 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
80103644:	e8 57 10 00 00       	call   801046a0 <release>
        return -1;
...
80103698:	e8 e3 0a 00 00       	call   80104180 <wakeup>
  release(&p->lock);
8010369d:	89 1c 24             	mov    %ebx,(%esp)
801036a0:	e8 fb 0f 00 00       	call   801046a0 <release>
  return n;
...
801036d6:	e8 25 10 00 00       	call   80104700 <acquire>
...
801036ee:	66 90                	xchg   %ax,%ax
    if(myproc()->killed){
801036f0:	e8 9b 02 00 00       	call   80103990 <myproc>
...
80103705:	e8 b6 09 00 00       	call   801040c0 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
80103766:	e8 15 0a 00 00       	call   80104180 <wakeup>
  release(&p->lock);
8010376b:	89 34 24             	mov    %esi,(%esp)
8010376e:	e8 2d 0f 00 00       	call   801046a0 <release>
  return i;
...
80103789:	e8 12 0f 00 00       	call   801046a0 <release>
      return -1;
...
801037b1:	e8 4a 0f 00 00       	call   80104700 <acquire>
...
801037c6:	81 fb 54 53 11 80    	cmp    $0x80115354,%ebx
801037cc:	0f 84 a6 00 00 00    	je     80103878 <allocproc+0xd8>
    if(p->state == UNUSED)
...
801037d9:	a1 04 b0 10 80       	mov    0x8010b004,%eax
  p->base_nice = NICE_DEFAULT;
  p->eff_nice = NICE_DEFAULT;
  p->pi_mask = 0;
...
801037f5:	8d 50 01             	lea    0x1(%eax),%edx
  p->base_nice = NICE_DEFAULT;
801037f8:	c7 83 8c 00 00 00 02 	movl   $0x2,0x8c(%ebx)
801037ff:	00 00 00 
  p->eff_nice = NICE_DEFAULT;
80103802:	c7 83 90 00 00 00 02 	movl   $0x2,0x90(%ebx)
80103809:	00 00 00 
  p->pi_mask = 0;
8010380c:	c7 83 94 00 00 00 00 	movl   $0x0,0x94(%ebx)
80103813:	00 00 00 
  release(&ptable.lock);
80103816:	68 20 2d 11 80       	push   $0x80112d20
  p->pid = nextpid++;
8010381b:	89 15 04 b0 10 80    	mov    %edx,0x8010b004
  release(&ptable.lock);
80103821:	e8 7a 0e 00 00       	call   801046a0 <release>

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
80103826:	e8 35 ee ff ff       	call   80102660 <kalloc>
8010382b:	83 c4 10             	add    $0x10,%esp
8010382e:	89 43 0c             	mov    %eax,0xc(%ebx)
80103831:	85 c0                	test   %eax,%eax
80103833:	74 5c                	je     80103891 <allocproc+0xf1>
    return 0;
  }
...
8010383e:	05 9c 0f 00 00       	add    $0xf9c,%eax
  sp -= sizeof *p->tf;
80103843:	89 53 1c             	mov    %edx,0x1c(%ebx)
  *(uint*)sp = (uint)trapret;
80103846:	c7 40 14 9f 5e 10 80 	movl   $0x80105e9f,0x14(%eax)
  p->context = (struct context*)sp;
8010384d:	89 43 20             	mov    %eax,0x20(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103850:	6a 14                	push   $0x14
80103852:	6a 00                	push   $0x0
80103854:	50                   	push   %eax
80103855:	e8 86 13 00 00       	call   80104be0 <memset>
  p->context->eip = (uint)forkret;
8010385a:	8b 43 20             	mov    0x20(%ebx),%eax
...
80103867:	89 d8                	mov    %ebx,%eax
  p->nice = NICE_DEFAULT;
80103869:	c7 03 02 00 00 00    	movl   $0x2,(%ebx)
}
...
80103882:	e8 19 0e 00 00       	call   801046a0 <release>
  return 0;
...
80103890:	c3                   	ret
    p->state = UNUSED;
80103891:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
  return 0;
80103898:	31 db                	xor    %ebx,%ebx
8010389a:	eb ee                	jmp    8010388a <allocproc+0xea>
...
801038f6:	68 30 7a 10 80       	push   $0x80107a30
801038fb:	68 20 2d 11 80       	push   $0x80112d20
80103900:	e8 0b 0c 00 00       	call   80104510 <initlock>
}
...
80103994:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103997:	e8 14 0c 00 00       	call   801045b0 <pushcli>
  c = mycpu();
8010399c:	e8 6f ff ff ff       	call   80103910 <mycpu>
  p = c->proc;
801039a1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039a7:	e8 54 0c 00 00       	call   80104600 <popcli>
}
...
801039c4:	83 ec 04             	sub    $0x4,%esp
  p = allocproc();
801039c7:	e8 d4 fd ff ff       	call   801037a0 <allocproc>
801039cc:	89 c3                	mov    %eax,%ebx
  initproc = p;
801039ce:	a3 54 53 11 80       	mov    %eax,0x80115354
  if((p->pgdir = setupkvm()) == 0)
801039d3:	e8 b8 3a 00 00       	call   80107490 <setupkvm>
801039d8:	89 43 08             	mov    %eax,0x8(%ebx)
801039db:	85 c0                	test   %eax,%eax
801039dd:	0f 84 be 00 00 00    	je     80103aa1 <userinit+0xe1>
...
801039f1:	e8 7a 37 00 00       	call   80107170 <inituvm>
  memset(p->tf, 0, sizeof(*p->tf));
801039f6:	83 c4 0c             	add    $0xc,%esp
  p->sz = PGSIZE;
801039f9:	c7 43 04 00 10 00 00 	movl   $0x1000,0x4(%ebx)
  memset(p->tf, 0, sizeof(*p->tf));
80103a00:	6a 4c                	push   $0x4c
80103a02:	6a 00                	push   $0x0
80103a04:	ff 73 1c             	push   0x1c(%ebx)
80103a07:	e8 d4 11 00 00       	call   80104be0 <memset>
...
80103a17:	b9 23 00 00 00       	mov    $0x23,%ecx
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
...
80103a51:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103a54:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)
  safestrcpy(p->name, "initcode", sizeof(p->name));
80103a5b:	8d 43 70             	lea    0x70(%ebx),%eax
80103a5e:	6a 10                	push   $0x10
80103a60:	68 60 7a 10 80       	push   $0x80107a60
80103a65:	50                   	push   %eax
80103a66:	e8 25 13 00 00       	call   80104d90 <safestrcpy>
  p->cwd = namei("/");
80103a6b:	c7 04 24 69 7a 10 80 	movl   $0x80107a69,(%esp)
80103a72:	e8 09 e6 ff ff       	call   80102080 <namei>
80103a77:	89 43 6c             	mov    %eax,0x6c(%ebx)
  acquire(&ptable.lock);
80103a7a:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103a81:	e8 7a 0c 00 00       	call   80104700 <acquire>
  p->state = RUNNABLE;
80103a86:	c7 43 10 03 00 00 00 	movl   $0x3,0x10(%ebx)
  release(&ptable.lock);
80103a8d:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103a94:	e8 07 0c 00 00       	call   801046a0 <release>
}
...
80103aa4:	68 47 7a 10 80       	push   $0x80107a47
80103aa9:	e8 d2 c8 ff ff       	call   80100380 <panic>
...
80103ab5:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103ab8:	e8 f3 0a 00 00       	call   801045b0 <pushcli>
  c = mycpu();
80103abd:	e8 4e fe ff ff       	call   80103910 <mycpu>
  p = c->proc;
80103ac2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ac8:	e8 33 0b 00 00       	call   80104600 <popcli>
  sz = curproc->sz;
80103acd:	8b 43 04             	mov    0x4(%ebx),%eax
  if(n > 0){
80103ad0:	85 f6                	test   %esi,%esi
80103ad2:	7f 1c                	jg     80103af0 <growproc+0x40>
  } else if(n < 0){
80103ad4:	75 3a                	jne    80103b10 <growproc+0x60>
  switchuvm(curproc);
80103ad6:	83 ec 0c             	sub    $0xc,%esp
  curproc->sz = sz;
80103ad9:	89 43 04             	mov    %eax,0x4(%ebx)
  switchuvm(curproc);
80103adc:	53                   	push   %ebx
80103add:	e8 7e 35 00 00       	call   80107060 <switchuvm>
  return 0;
80103ae2:	83 c4 10             	add    $0x10,%esp
80103ae5:	31 c0                	xor    %eax,%eax
}
...
80103af7:	ff 73 08             	push   0x8(%ebx)
80103afa:	e8 c1 37 00 00       	call   801072c0 <allocuvm>
80103aff:	83 c4 10             	add    $0x10,%esp
80103b02:	85 c0                	test   %eax,%eax
80103b04:	75 d0                	jne    80103ad6 <growproc+0x26>
      return -1;
80103b06:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103b0b:	eb da                	jmp    80103ae7 <growproc+0x37>
...
80103b17:	ff 73 08             	push   0x8(%ebx)
80103b1a:	e8 c1 38 00 00       	call   801073e0 <deallocuvm>
80103b1f:	83 c4 10             	add    $0x10,%esp
80103b22:	85 c0                	test   %eax,%eax
80103b24:	75 b0                	jne    80103ad6 <growproc+0x26>
...
80103b36:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b39:	e8 72 0a 00 00       	call   801045b0 <pushcli>
  c = mycpu();
80103b3e:	e8 cd fd ff ff       	call   80103910 <mycpu>
  p = c->proc;
80103b43:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b49:	e8 b2 0a 00 00       	call   80104600 <popcli>
  if((np = allocproc()) == 0){
80103b4e:	e8 4d fc ff ff       	call   801037a0 <allocproc>
...
80103b61:	ff 73 04             	push   0x4(%ebx)
80103b64:	89 c7                	mov    %eax,%edi
80103b66:	ff 73 08             	push   0x8(%ebx)
80103b69:	e8 12 3a 00 00       	call   80107580 <copyuvm>
80103b6e:	83 c4 10             	add    $0x10,%esp
80103b71:	89 47 08             	mov    %eax,0x8(%edi)
80103b74:	85 c0                	test   %eax,%eax
80103b76:	0f 84 b9 00 00 00    	je     80103c35 <fork+0x105>
  np->sz = curproc->sz;
80103b7c:	8b 43 04             	mov    0x4(%ebx),%eax
80103b7f:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80103b82:	89 41 04             	mov    %eax,0x4(%ecx)
  *np->tf = *curproc->tf;
80103b85:	8b 79 1c             	mov    0x1c(%ecx),%edi
  np->parent = curproc;
80103b88:	89 c8                	mov    %ecx,%eax
80103b8a:	89 59 18             	mov    %ebx,0x18(%ecx)
  *np->tf = *curproc->tf;
80103b8d:	b9 13 00 00 00       	mov    $0x13,%ecx
80103b92:	8b 73 1c             	mov    0x1c(%ebx),%esi
80103b95:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  for(i = 0; i < NOFILE; i++)
80103b97:	31 f6                	xor    %esi,%esi
  np->tf->eax = 0;
80103b99:	8b 40 1c             	mov    0x1c(%eax),%eax
80103b9c:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
  for(i = 0; i < NOFILE; i++)
80103ba3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
    if(curproc->ofile[i])
80103ba8:	8b 44 b3 2c          	mov    0x2c(%ebx,%esi,4),%eax
80103bac:	85 c0                	test   %eax,%eax
80103bae:	74 13                	je     80103bc3 <fork+0x93>
      np->ofile[i] = filedup(curproc->ofile[i]);
80103bb0:	83 ec 0c             	sub    $0xc,%esp
80103bb3:	50                   	push   %eax
80103bb4:	e8 07 d3 ff ff       	call   80100ec0 <filedup>
80103bb9:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80103bbc:	83 c4 10             	add    $0x10,%esp
80103bbf:	89 44 b2 2c          	mov    %eax,0x2c(%edx,%esi,4)
  for(i = 0; i < NOFILE; i++)
...
80103bce:	ff 73 6c             	push   0x6c(%ebx)
80103bd1:	e8 9a db ff ff       	call   80101770 <idup>
80103bd6:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103bd9:	83 c4 0c             	add    $0xc,%esp
  np->cwd = idup(curproc->cwd);
80103bdc:	89 47 6c             	mov    %eax,0x6c(%edi)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103bdf:	8d 43 70             	lea    0x70(%ebx),%eax
80103be2:	6a 10                	push   $0x10
80103be4:	50                   	push   %eax
80103be5:	8d 47 70             	lea    0x70(%edi),%eax
80103be8:	50                   	push   %eax
80103be9:	e8 a2 11 00 00       	call   80104d90 <safestrcpy>
  np->base_nice = curproc->base_nice;
80103bee:	8b 83 8c 00 00 00    	mov    0x8c(%ebx),%eax
80103bf4:	89 87 8c 00 00 00    	mov    %eax,0x8c(%edi)
  np->eff_nice = curproc->eff_nice;
80103bfa:	8b 83 90 00 00 00    	mov    0x90(%ebx),%eax
  pid = np->pid;
80103c00:	8b 5f 14             	mov    0x14(%edi),%ebx
  np->eff_nice = curproc->eff_nice;
80103c03:	89 87 90 00 00 00    	mov    %eax,0x90(%edi)
  acquire(&ptable.lock);
80103c09:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103c10:	e8 eb 0a 00 00       	call   80104700 <acquire>
  np->state = RUNNABLE;
...
80103c3b:	ff 73 0c             	push   0xc(%ebx)
80103c3e:	e8 5d e8 ff ff       	call   801024a0 <kfree>
    np->kstack = 0;
80103c43:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    return -1;
80103c4a:	83 c4 10             	add    $0x10,%esp
    np->state = UNUSED;
80103c4d:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
    return -1;
...
80103c69:	83 ec 0c             	sub    $0xc,%esp
    struct proc *highp = 0;
80103c6c:	31 db                	xor    %ebx,%ebx
    acquire(&ptable.lock);
80103c6e:	68 20 2d 11 80       	push   $0x80112d20
80103c73:	e8 88 0a 00 00       	call   80104700 <acquire>
80103c78:	83 c4 10             	add    $0x10,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c7b:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103c80:	eb 14                	jmp    80103c96 <scheduler+0x36>
80103c82:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        highp = p;
80103c88:	89 c3                	mov    %eax,%ebx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c8a:	05 98 00 00 00       	add    $0x98,%eax
80103c8f:	3d 54 53 11 80       	cmp    $0x80115354,%eax
80103c94:	74 3f                	je     80103cd5 <scheduler+0x75>
      if(p->state != RUNNABLE)
80103c96:	83 78 10 03          	cmpl   $0x3,0x10(%eax)
80103c9a:	75 ee                	jne    80103c8a <scheduler+0x2a>
      if(!highp || p->eff_nice < highp->eff_nice)
80103c9c:	85 db                	test   %ebx,%ebx
80103c9e:	74 e8                	je     80103c88 <scheduler+0x28>
80103ca0:	8b 8b 90 00 00 00    	mov    0x90(%ebx),%ecx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ca6:	8d 90 98 00 00 00    	lea    0x98(%eax),%edx
      if(!highp || p->eff_nice < highp->eff_nice)
80103cac:	39 88 90 00 00 00    	cmp    %ecx,0x90(%eax)
80103cb2:	0f 8d 88 00 00 00    	jge    80103d40 <scheduler+0xe0>
        highp = p;
80103cb8:	89 c3                	mov    %eax,%ebx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cba:	3d bc 52 11 80       	cmp    $0x801152bc,%eax
80103cbf:	74 18                	je     80103cd9 <scheduler+0x79>
      if(p->state != RUNNABLE)
80103cc1:	83 7a 10 03          	cmpl   $0x3,0x10(%edx)
80103cc5:	74 69                	je     80103d30 <scheduler+0xd0>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cc7:	89 d0                	mov    %edx,%eax
80103cc9:	05 98 00 00 00       	add    $0x98,%eax
80103cce:	3d 54 53 11 80       	cmp    $0x80115354,%eax
80103cd3:	75 c1                	jne    80103c96 <scheduler+0x36>
    if(highp){
80103cd5:	85 db                	test   %ebx,%ebx
80103cd7:	74 3d                	je     80103d16 <scheduler+0xb6>
      struct cpu *c = mycpu();
80103cd9:	e8 32 fc ff ff       	call   80103910 <mycpu>
      switchuvm(highp);
80103cde:	83 ec 0c             	sub    $0xc,%esp
      c->proc = highp;
80103ce1:	89 98 ac 00 00 00    	mov    %ebx,0xac(%eax)
      struct cpu *c = mycpu();
80103ce7:	89 c6                	mov    %eax,%esi
      switchuvm(highp);
80103ce9:	53                   	push   %ebx
80103cea:	e8 71 33 00 00       	call   80107060 <switchuvm>
      highp->state = RUNNING;
80103cef:	c7 43 10 04 00 00 00 	movl   $0x4,0x10(%ebx)
      swtch(&c->scheduler, highp->context);
80103cf6:	58                   	pop    %eax
80103cf7:	8d 46 04             	lea    0x4(%esi),%eax
80103cfa:	5a                   	pop    %edx
80103cfb:	ff 73 20             	push   0x20(%ebx)
80103cfe:	50                   	push   %eax
80103cff:	e8 e7 10 00 00       	call   80104deb <swtch>
      switchkvm();
80103d04:	e8 47 33 00 00       	call   80107050 <switchkvm>
      c->proc = 0;
...
80103d1e:	e8 7d 09 00 00       	call   801046a0 <release>
  for(;;){
80103d23:	83 c4 10             	add    $0x10,%esp
80103d26:	e9 3d ff ff ff       	jmp    80103c68 <scheduler+0x8>
80103d2b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
        highp = p;
80103d30:	89 d0                	mov    %edx,%eax
80103d32:	e9 69 ff ff ff       	jmp    80103ca0 <scheduler+0x40>
80103d37:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80103d3e:	00 
80103d3f:	90                   	nop
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d40:	3d bc 52 11 80       	cmp    $0x801152bc,%eax
80103d45:	0f 85 76 ff ff ff    	jne    80103cc1 <scheduler+0x61>
80103d4b:	eb 88                	jmp    80103cd5 <scheduler+0x75>
...
80103d97:	75 41                	jne    80103dda <sched+0x8a>
  intena = mycpu()->intena;
80103d99:	e8 72 fb ff ff       	call   80103910 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103d9e:	83 c3 20             	add    $0x20,%ebx
  intena = mycpu()->intena;
80103da1:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103da7:	e8 64 fb ff ff       	call   80103910 <mycpu>
80103dac:	83 ec 08             	sub    $0x8,%esp
80103daf:	ff 70 04             	push   0x4(%eax)
80103db2:	53                   	push   %ebx
80103db3:	e8 33 10 00 00       	call   80104deb <swtch>
  mycpu()->intena = intena;
80103db8:	e8 53 fb ff ff       	call   80103910 <mycpu>
}
...
80103e16:	83 ec 0c             	sub    $0xc,%esp
  struct proc *curproc = myproc();
80103e19:	e8 72 fb ff ff       	call   80103990 <myproc>
  if(curproc == initproc)
80103e1e:	39 05 54 53 11 80    	cmp    %eax,0x80115354
80103e24:	0f 84 07 01 00 00    	je     80103f31 <exit+0x121>
80103e2a:	89 c3                	mov    %eax,%ebx
80103e2c:	8d 70 2c             	lea    0x2c(%eax),%esi
80103e2f:	8d 78 6c             	lea    0x6c(%eax),%edi
...
80103e5f:	ff 73 6c             	push   0x6c(%ebx)
80103e62:	e8 69 da ff ff       	call   801018d0 <iput>
  end_op();
80103e67:	e8 44 ef ff ff       	call   80102db0 <end_op>
  curproc->cwd = 0;
80103e6c:	c7 43 6c 00 00 00 00 	movl   $0x0,0x6c(%ebx)
  acquire(&ptable.lock);
80103e73:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103e7a:	e8 81 08 00 00       	call   80104700 <acquire>
  wakeup1(curproc->parent);
80103e7f:	8b 53 18             	mov    0x18(%ebx),%edx
...
80103e9c:	83 78 10 02          	cmpl   $0x2,0x10(%eax)
80103ea0:	75 ee                	jne    80103e90 <exit+0x80>
80103ea2:	3b 50 24             	cmp    0x24(%eax),%edx
80103ea5:	75 e9                	jne    80103e90 <exit+0x80>
      p->state = RUNNABLE;
80103ea7:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103eae:	05 98 00 00 00       	add    $0x98,%eax
80103eb3:	3d 54 53 11 80       	cmp    $0x80115354,%eax
80103eb8:	75 e2                	jne    80103e9c <exit+0x8c>
      p->parent = initproc;
80103eba:	8b 0d 54 53 11 80    	mov    0x80115354,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ec0:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
80103ec5:	eb 17                	jmp    80103ede <exit+0xce>
80103ec7:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80103ece:	00 
80103ecf:	90                   	nop
80103ed0:	81 c2 98 00 00 00    	add    $0x98,%edx
80103ed6:	81 fa 54 53 11 80    	cmp    $0x80115354,%edx
80103edc:	74 3a                	je     80103f18 <exit+0x108>
    if(p->parent == curproc){
80103ede:	39 5a 18             	cmp    %ebx,0x18(%edx)
80103ee1:	75 ed                	jne    80103ed0 <exit+0xc0>
      if(p->state == ZOMBIE)
80103ee3:	83 7a 10 05          	cmpl   $0x5,0x10(%edx)
      p->parent = initproc;
80103ee7:	89 4a 18             	mov    %ecx,0x18(%edx)
      if(p->state == ZOMBIE)
...
80103f44:	53                   	push   %ebx
  pushcli();
80103f45:	e8 66 06 00 00       	call   801045b0 <pushcli>
  c = mycpu();
80103f4a:	e8 c1 f9 ff ff       	call   80103910 <mycpu>
  p = c->proc;
80103f4f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103f55:	e8 a6 06 00 00       	call   80104600 <popcli>
  acquire(&ptable.lock);
80103f5a:	83 ec 0c             	sub    $0xc,%esp
80103f5d:	68 20 2d 11 80       	push   $0x80112d20
80103f62:	e8 99 07 00 00       	call   80104700 <acquire>
...
80103f78:	81 c3 98 00 00 00    	add    $0x98,%ebx
80103f7e:	81 fb 54 53 11 80    	cmp    $0x80115354,%ebx
80103f84:	74 1e                	je     80103fa4 <wait+0x64>
      if(p->parent != curproc)
80103f86:	39 73 18             	cmp    %esi,0x18(%ebx)
80103f89:	75 ed                	jne    80103f78 <wait+0x38>
      if(p->state == ZOMBIE){
80103f8b:	83 7b 10 05          	cmpl   $0x5,0x10(%ebx)
80103f8f:	74 5f                	je     80103ff0 <wait+0xb0>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f91:	81 c3 98 00 00 00    	add    $0x98,%ebx
      havekids = 1;
80103f97:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f9c:	81 fb 54 53 11 80    	cmp    $0x80115354,%ebx
80103fa2:	75 e2                	jne    80103f86 <wait+0x46>
    if(!havekids || curproc->killed){
80103fa4:	85 c0                	test   %eax,%eax
80103fa6:	0f 84 9a 00 00 00    	je     80104046 <wait+0x106>
80103fac:	8b 46 28             	mov    0x28(%esi),%eax
80103faf:	85 c0                	test   %eax,%eax
80103fb1:	0f 85 8f 00 00 00    	jne    80104046 <wait+0x106>
  pushcli();
80103fb7:	e8 f4 05 00 00       	call   801045b0 <pushcli>
  c = mycpu();
80103fbc:	e8 4f f9 ff ff       	call   80103910 <mycpu>
  p = c->proc;
80103fc1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103fc7:	e8 34 06 00 00       	call   80104600 <popcli>
  if(p == 0)
80103fcc:	85 db                	test   %ebx,%ebx
80103fce:	0f 84 89 00 00 00    	je     8010405d <wait+0x11d>
  p->chan = chan;
80103fd4:	89 73 24             	mov    %esi,0x24(%ebx)
  p->state = SLEEPING;
80103fd7:	c7 43 10 02 00 00 00 	movl   $0x2,0x10(%ebx)
  sched();
80103fde:	e8 6d fd ff ff       	call   80103d50 <sched>
  p->chan = 0;
80103fe3:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
}
...
80103ff0:	83 ec 0c             	sub    $0xc,%esp
        pid = p->pid;
80103ff3:	8b 73 14             	mov    0x14(%ebx),%esi
        kfree(p->kstack);
80103ff6:	ff 73 0c             	push   0xc(%ebx)
80103ff9:	e8 a2 e4 ff ff       	call   801024a0 <kfree>
        p->kstack = 0;
80103ffe:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        freevm(p->pgdir);
80104005:	5a                   	pop    %edx
80104006:	ff 73 08             	push   0x8(%ebx)
80104009:	e8 02 34 00 00       	call   80107410 <freevm>
        p->pid = 0;
8010400e:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->parent = 0;
80104015:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
        p->name[0] = 0;
8010401c:	c6 43 70 00          	movb   $0x0,0x70(%ebx)
        p->killed = 0;
80104020:	c7 43 28 00 00 00 00 	movl   $0x0,0x28(%ebx)
        p->state = UNUSED;
80104027:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        release(&ptable.lock);
8010402e:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80104035:	e8 66 06 00 00       	call   801046a0 <release>
        return pid;
...
8010407c:	e8 7f 06 00 00       	call   80104700 <acquire>
  pushcli();
80104081:	e8 2a 05 00 00       	call   801045b0 <pushcli>
  c = mycpu();
80104086:	e8 85 f8 ff ff       	call   80103910 <mycpu>
  p = c->proc;
8010408b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104091:	e8 6a 05 00 00       	call   80104600 <popcli>
  myproc()->state = RUNNABLE;
80104096:	c7 43 10 03 00 00 00 	movl   $0x3,0x10(%ebx)
  sched();
8010409d:	e8 ae fc ff ff       	call   80103d50 <sched>
  release(&ptable.lock);
801040a2:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801040a9:	e8 f2 05 00 00       	call   801046a0 <release>
}
...
801040cc:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
801040cf:	e8 dc 04 00 00       	call   801045b0 <pushcli>
  c = mycpu();
801040d4:	e8 37 f8 ff ff       	call   80103910 <mycpu>
  p = c->proc;
801040d9:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801040df:	e8 1c 05 00 00       	call   80104600 <popcli>
  if(p == 0)
...
80104100:	e8 fb 05 00 00       	call   80104700 <acquire>
    release(lk);
80104105:	89 34 24             	mov    %esi,(%esp)
80104108:	e8 93 05 00 00       	call   801046a0 <release>
  p->chan = chan;
8010410d:	89 7b 24             	mov    %edi,0x24(%ebx)
  p->state = SLEEPING;
80104110:	c7 43 10 02 00 00 00 	movl   $0x2,0x10(%ebx)
  sched();
80104117:	e8 34 fc ff ff       	call   80103d50 <sched>
  p->chan = 0;
8010411c:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
    release(&ptable.lock);
80104123:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
8010412a:	e8 71 05 00 00       	call   801046a0 <release>
    acquire(lk);
8010412f:	83 c4 10             	add    $0x10,%esp
80104132:	89 75 08             	mov    %esi,0x8(%ebp)
}
...
8010413b:	5d                   	pop    %ebp
    acquire(lk);
8010413c:	e9 bf 05 00 00       	jmp    80104700 <acquire>
80104141:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  p->chan = chan;
80104148:	89 7b 24             	mov    %edi,0x24(%ebx)
  p->state = SLEEPING;
8010414b:	c7 43 10 02 00 00 00 	movl   $0x2,0x10(%ebx)
  sched();
80104152:	e8 f9 fb ff ff       	call   80103d50 <sched>
  p->chan = 0;
80104157:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
}
...
80104169:	68 ca 7a 10 80       	push   $0x80107aca
8010416e:	e8 0d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
80104173:	83 ec 0c             	sub    $0xc,%esp
80104176:	68 c4 7a 10 80       	push   $0x80107ac4
...
8010418f:	e8 6c 05 00 00       	call   80104700 <acquire>
...
801041a0:	05 98 00 00 00       	add    $0x98,%eax
801041a5:	3d 54 53 11 80       	cmp    $0x80115354,%eax
801041aa:	74 1e                	je     801041ca <wakeup+0x4a>
    if(p->state == SLEEPING && p->chan == chan)
801041ac:	83 78 10 02          	cmpl   $0x2,0x10(%eax)
801041b0:	75 ee                	jne    801041a0 <wakeup+0x20>
801041b2:	3b 58 24             	cmp    0x24(%eax),%ebx
801041b5:	75 e9                	jne    801041a0 <wakeup+0x20>
      p->state = RUNNABLE;
801041b7:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801041be:	05 98 00 00 00       	add    $0x98,%eax
801041c3:	3d 54 53 11 80       	cmp    $0x80115354,%eax
...
801041d4:	c9                   	leave
  release(&ptable.lock);
801041d5:	e9 c6 04 00 00       	jmp    801046a0 <release>
...
801041ef:	e8 0c 05 00 00       	call   80104700 <acquire>
...
80104205:	3d 54 53 11 80       	cmp    $0x80115354,%eax
8010420a:	74 34                	je     80104240 <kill+0x60>
    if(p->pid == pid){
8010420c:	39 58 14             	cmp    %ebx,0x14(%eax)
8010420f:	75 ef                	jne    80104200 <kill+0x20>
      p->killed = 1;
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
80104211:	83 78 10 02          	cmpl   $0x2,0x10(%eax)
      p->killed = 1;
80104215:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
      if(p->state == SLEEPING)
8010421c:	75 07                	jne    80104225 <kill+0x45>
        p->state = RUNNABLE;
8010421e:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
      release(&ptable.lock);
80104225:	83 ec 0c             	sub    $0xc,%esp
80104228:	68 20 2d 11 80       	push   $0x80112d20
8010422d:	e8 6e 04 00 00       	call   801046a0 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80104248:	e8 53 04 00 00       	call   801046a0 <release>
}
...
80104269:	bb c4 2d 11 80       	mov    $0x80112dc4,%ebx
...
8010427b:	68 90 7c 10 80       	push   $0x80107c90
80104280:	e8 2b c4 ff ff       	call   801006b0 <cprintf>
80104285:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104288:	81 c3 98 00 00 00    	add    $0x98,%ebx
8010428e:	81 fb c4 53 11 80    	cmp    $0x801153c4,%ebx
...
8010429f:	74 e7                	je     80104288 <procdump+0x28>
      state = "???";
801042a1:	ba db 7a 10 80       	mov    $0x80107adb,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801042a6:	83 f8 05             	cmp    $0x5,%eax
801042a9:	77 11                	ja     801042bc <procdump+0x5c>
801042ab:	8b 14 85 c0 80 10 80 	mov    -0x7fef7f40(,%eax,4),%edx
      state = "???";
801042b2:	b8 db 7a 10 80       	mov    $0x80107adb,%eax
...
801042c1:	68 df 7a 10 80       	push   $0x80107adf
...
801042e8:	e8 43 02 00 00       	call   80104530 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
801042fd:	68 21 78 10 80       	push   $0x80107821
...
80104325:	8b 75 0c             	mov    0xc(%ebp),%esi
80104328:	8b 45 08             	mov    0x8(%ebp),%eax
  struct proc *p;
  if (value < 0 || value > 4)
8010432b:	83 fe 04             	cmp    $0x4,%esi
8010432e:	77 60                	ja     80104390 <setnice+0x70>
    return -1;
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80104330:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80104335:	eb 17                	jmp    8010434e <setnice+0x2e>
80104337:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010433e:	00 
8010433f:	90                   	nop
80104340:	81 c3 98 00 00 00    	add    $0x98,%ebx
80104346:	81 fb 54 53 11 80    	cmp    $0x80115354,%ebx
8010434c:	74 42                	je     80104390 <setnice+0x70>
    if (p->pid == pid) {
8010434e:	39 43 14             	cmp    %eax,0x14(%ebx)
80104351:	75 ed                	jne    80104340 <setnice+0x20>
      acquire(&ptable.lock);
80104353:	83 ec 0c             	sub    $0xc,%esp
80104356:	68 20 2d 11 80       	push   $0x80112d20
8010435b:	e8 a0 03 00 00       	call   80104700 <acquire>
      p->base_nice = value;
80104360:	89 b3 8c 00 00 00    	mov    %esi,0x8c(%ebx)
      p->eff_nice = value;
80104366:	89 b3 90 00 00 00    	mov    %esi,0x90(%ebx)
      release(&ptable.lock);
8010436c:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80104373:	e8 28 03 00 00       	call   801046a0 <release>
      return p->eff_nice;
80104378:	8b 83 90 00 00 00    	mov    0x90(%ebx),%eax
...
801043a0:	55                   	push   %ebp
  struct proc *p;
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
801043a1:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
int getnice(int pid) {
801043a6:	89 e5                	mov    %esp,%ebp
801043a8:	8b 55 08             	mov    0x8(%ebp),%edx
801043ab:	eb 0f                	jmp    801043bc <getnice+0x1c>
801043ad:	8d 76 00             	lea    0x0(%esi),%esi
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
801043b0:	05 98 00 00 00       	add    $0x98,%eax
801043b5:	3d 54 53 11 80       	cmp    $0x80115354,%eax
801043ba:	74 14                	je     801043d0 <getnice+0x30>
    if (p->pid == pid) {
801043bc:	39 50 14             	cmp    %edx,0x14(%eax)
801043bf:	75 ef                	jne    801043b0 <getnice+0x10>
      return p->eff_nice;
801043c1:	8b 80 90 00 00 00    	mov    0x90(%eax),%eax
    }
  }
  return -1;
}
...
801043ea:	68 12 7b 10 80       	push   $0x80107b12
...
8010442f:	e8 cc 02 00 00       	call   80104700 <acquire>
  while (lk->locked) {
...
80104445:	e8 76 fc ff ff       	call   801040c0 <sleep>
  while (lk->locked) {
...
80104453:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104459:	e8 32 f5 ff ff       	call   80103990 <myproc>
8010445e:	8b 40 14             	mov    0x14(%eax),%eax
...
8010446c:	5d                   	pop    %ebp
  release(&lk->lk);
8010446d:	e9 2e 02 00 00       	jmp    801046a0 <release>
...
8010448f:	e8 6c 02 00 00       	call   80104700 <acquire>
  lk->locked = 0;
...
801044a4:	e8 d7 fc ff ff       	call   80104180 <wakeup>
  release(&lk->lk);
...
801044b4:	5d                   	pop    %ebp
  release(&lk->lk);
801044b5:	e9 e6 01 00 00       	jmp    801046a0 <release>
...
801044d2:	e8 29 02 00 00       	call   80104700 <acquire>
...
801044e4:	e8 b7 01 00 00       	call   801046a0 <release>
  return r;
}
...
801044fb:	e8 90 f4 ff ff       	call   80103990 <myproc>
80104500:	39 58 14             	cmp    %ebx,0x14(%eax)
...
8010453d:	05 f8 ff ff 7f       	add    $0x7ffffff8,%eax
80104542:	3d fe ff ff 7f       	cmp    $0x7ffffffe,%eax
  for(i = 0; i < 10; i++){
80104547:	b8 00 00 00 00       	mov    $0x0,%eax
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
8010454c:	76 10                	jbe    8010455e <getcallerpcs+0x2e>
8010454e:	eb 28                	jmp    80104578 <getcallerpcs+0x48>
80104550:	8d 9a 00 00 00 80    	lea    -0x80000000(%edx),%ebx
80104556:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
8010455c:	77 1a                	ja     80104578 <getcallerpcs+0x48>
      break;
...
8010456c:	75 e2                	jne    80104550 <getcallerpcs+0x20>
  }
  for(; i < 10; i++)
    pcs[i] = 0;
}
...
80104578:	8d 04 81             	lea    (%ecx,%eax,4),%eax
8010457b:	83 c1 28             	add    $0x28,%ecx
8010457e:	89 ca                	mov    %ecx,%edx
80104580:	29 c2                	sub    %eax,%edx
80104582:	83 e2 04             	and    $0x4,%edx
80104585:	74 11                	je     80104598 <getcallerpcs+0x68>
    pcs[i] = 0;
80104587:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; i < 10; i++)
8010458d:	83 c0 04             	add    $0x4,%eax
80104590:	39 c1                	cmp    %eax,%ecx
80104592:	74 da                	je     8010456e <getcallerpcs+0x3e>
80104594:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    pcs[i] = 0;
80104598:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; i < 10; i++)
8010459e:	83 c0 08             	add    $0x8,%eax
    pcs[i] = 0;
801045a1:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
  for(; i < 10; i++)
801045a8:	39 c1                	cmp    %eax,%ecx
801045aa:	75 ec                	jne    80104598 <getcallerpcs+0x68>
801045ac:	eb c0                	jmp    8010456e <getcallerpcs+0x3e>
...
801045da:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    mycpu()->intena = eflags & FL_IF;
801045e0:	e8 2b f3 ff ff       	call   80103910 <mycpu>
...
801045f3:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801045fa:	00 
...
8010460b:	75 35                	jne    80104642 <popcli+0x42>
  ...
  if(--mycpu()->ncli < 0)
8010460d:	e8 fe f2 ff ff       	call   80103910 <mycpu>
...
8010462c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104630:	e8 db f2 ff ff       	call   80103910 <mycpu>
...
80104645:	68 1d 7b 10 80       	push   $0x80107b1d
8010464a:	e8 31 bd ff ff       	call   80100380 <panic>
    panic("popcli");
8010464f:	83 ec 0c             	sub    $0xc,%esp
80104652:	68 34 7b 10 80       	push   $0x80107b34
...
80104683:	e8 88 f2 ff ff       	call   80103910 <mycpu>
...
80104718:	0f 85 b2 00 00 00    	jne    801047d0 <acquire+0xd0>
  popcli();
8010471e:	e8 dd fe ff ff       	call   80104600 <popcli>
  asm volatile("lock; xchgl %0, %1" :
80104723:	b9 01 00 00 00       	mov    $0x1,%ecx
...
80104744:	e8 c7 f1 ff ff       	call   80103910 <mycpu>
...
80104794:	83 c1 34             	add    $0x34,%ecx
80104797:	89 ca                	mov    %ecx,%edx
80104799:	29 c2                	sub    %eax,%edx
8010479b:	83 e2 04             	and    $0x4,%edx
8010479e:	74 10                	je     801047b0 <acquire+0xb0>
    pcs[i] = 0;
801047a0:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; i < 10; i++)
801047a6:	83 c0 04             	add    $0x4,%eax
801047a9:	39 c1                	cmp    %eax,%ecx
801047ab:	74 da                	je     80104787 <acquire+0x87>
801047ad:	8d 76 00             	lea    0x0(%esi),%esi
    pcs[i] = 0;
801047b0:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; i < 10; i++)
801047b6:	83 c0 08             	add    $0x8,%eax
    pcs[i] = 0;
801047b9:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
  for(; i < 10; i++)
801047c0:	39 c1                	cmp    %eax,%ecx
801047c2:	75 ec                	jne    801047b0 <acquire+0xb0>
801047c4:	eb c1                	jmp    80104787 <acquire+0x87>
801047c6:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801047cd:	00 
801047ce:	66 90                	xchg   %ax,%ax
  r = lock->locked && lock->cpu == mycpu();
801047d0:	8b 5b 08             	mov    0x8(%ebx),%ebx
801047d3:	e8 38 f1 ff ff       	call   80103910 <mycpu>
801047d8:	39 c3                	cmp    %eax,%ebx
801047da:	0f 85 3e ff ff ff    	jne    8010471e <acquire+0x1e>
  popcli();
801047e0:	e8 1b fe ff ff       	call   80104600 <popcli>
    panic("acquire");
801047e5:	83 ec 0c             	sub    $0xc,%esp
801047e8:	68 43 7b 10 80       	push   $0x80107b43
801047ed:	e8 8e bb ff ff       	call   80100380 <panic>
...
80104800 <recompute_proc_priority>:
...
8010480a:	83 ec 04             	sub    $0x4,%esp
  int new_nice = p->base_nice;
8010480d:	8b 90 8c 00 00 00    	mov    0x8c(%eax),%edx
  for(int i = 0; i < MAX_PI_LOCKS; i++){
80104813:	eb 0e                	jmp    80104823 <recompute_proc_priority+0x23>
80104815:	8d 76 00             	lea    0x0(%esi),%esi
80104818:	83 c1 44             	add    $0x44,%ecx
8010481b:	81 f9 dc 01 00 00    	cmp    $0x1dc,%ecx
80104821:	74 6b                	je     8010488e <recompute_proc_priority+0x8e>
    if(pi_locks[i].owner == p){
80104823:	39 1c 8d a8 53 11 80 	cmp    %ebx,-0x7feeac58(,%ecx,4)
8010482a:	75 ec                	jne    80104818 <recompute_proc_priority+0x18>
  for(int i = 0; i < l->waiter_count; i++){
8010482c:	8b 34 8d ac 54 11 80 	mov    -0x7feeab54(,%ecx,4),%esi
80104833:	85 f6                	test   %esi,%esi
80104835:	7e e1                	jle    80104818 <recompute_proc_priority+0x18>
  int best = NICE_MAX + 1;
80104837:	89 55 f0             	mov    %edx,-0x10(%ebp)
8010483a:	01 ce                	add    %ecx,%esi
8010483c:	8d 04 8d a0 53 11 80 	lea    -0x7feeac60(,%ecx,4),%eax
80104843:	8d 3c b5 a0 53 11 80 	lea    -0x7feeac60(,%esi,4),%edi
8010484a:	be 05 00 00 00       	mov    $0x5,%esi
8010484f:	90                   	nop
    struct proc *w = l->waiters[i];
80104850:	8b 50 0c             	mov    0xc(%eax),%edx
    if(w && w->state != UNUSED && w->eff_nice < best)
80104853:	85 d2                	test   %edx,%edx
80104855:	74 11                	je     80104868 <recompute_proc_priority+0x68>
80104857:	83 7a 10 00          	cmpl   $0x0,0x10(%edx)
8010485b:	74 0b                	je     80104868 <recompute_proc_priority+0x68>
8010485d:	8b 92 90 00 00 00    	mov    0x90(%edx),%edx
80104863:	39 d6                	cmp    %edx,%esi
80104865:	0f 4f f2             	cmovg  %edx,%esi
  for(int i = 0; i < l->waiter_count; i++){
80104868:	83 c0 04             	add    $0x4,%eax
8010486b:	39 f8                	cmp    %edi,%eax
8010486d:	75 e1                	jne    80104850 <recompute_proc_priority+0x50>
  return best == NICE_MAX + 1 ? -1 : best;
8010486f:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104872:	83 fe 05             	cmp    $0x5,%esi
80104875:	74 a1                	je     80104818 <recompute_proc_priority+0x18>
      int candidate = best_waiter_nice(&pi_locks[i]);
      if(candidate >= 0 && candidate < new_nice)
        new_nice = candidate;
80104877:	39 f2                	cmp    %esi,%edx
80104879:	89 d0                	mov    %edx,%eax
8010487b:	0f 4f d6             	cmovg  %esi,%edx
8010487e:	85 f6                	test   %esi,%esi
80104880:	0f 48 d0             	cmovs  %eax,%edx
  for(int i = 0; i < MAX_PI_LOCKS; i++){
80104883:	83 c1 44             	add    $0x44,%ecx
80104886:	81 f9 dc 01 00 00    	cmp    $0x1dc,%ecx
8010488c:	75 95                	jne    80104823 <recompute_proc_priority+0x23>
    }
  }
  p->eff_nice = new_nice;
8010488e:	89 93 90 00 00 00    	mov    %edx,0x90(%ebx)
}
...
801048a6:	68 4b 7b 10 80       	push   $0x80107b4b
801048ab:	68 60 53 11 80       	push   $0x80115360
801048b0:	e8 5b fc ff ff       	call   80104510 <initlock>
  for(int i = 0; i < MAX_PI_LOCKS; i++){
801048b5:	b8 a0 53 11 80       	mov    $0x801153a0,%eax
801048ba:	83 c4 10             	add    $0x10,%esp
801048bd:	8d 76 00             	lea    0x0(%esi),%esi
    pi_locks[i].used = 0;
801048c0:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(int i = 0; i < MAX_PI_LOCKS; i++){
801048c6:	05 10 01 00 00       	add    $0x110,%eax
    pi_locks[i].locked = 0;
801048cb:	c7 80 f4 fe ff ff 00 	movl   $0x0,-0x10c(%eax)
801048d2:	00 00 00 
    pi_locks[i].owner = 0;
801048d5:	c7 80 f8 fe ff ff 00 	movl   $0x0,-0x108(%eax)
801048dc:	00 00 00 
    pi_locks[i].waiter_count = 0;
801048df:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
  for(int i = 0; i < MAX_PI_LOCKS; i++){
801048e6:	3d 10 5b 11 80       	cmp    $0x80115b10,%eax
801048eb:	75 d3                	jne    801048c0 <pi_init+0x20>
  }
}
801048ed:	c9                   	leave
801048ee:	c3                   	ret
...
801048f9:	83 7d 08 06          	cmpl   $0x6,0x8(%ebp)
801048fd:	0f 87 cb 01 00 00    	ja     80104ace <pi_lock_acquire+0x1de>
    return -1;

  struct proc *cur = myproc();
80104903:	e8 88 f0 ff ff       	call   80103990 <myproc>

  acquire(&ptable.lock);
80104908:	83 ec 0c             	sub    $0xc,%esp
8010490b:	68 20 2d 11 80       	push   $0x80112d20
  struct proc *cur = myproc();
80104910:	89 c3                	mov    %eax,%ebx
  acquire(&ptable.lock);
80104912:	e8 e9 fd ff ff       	call   80104700 <acquire>
  acquire(&pi_table_lock);
80104917:	c7 04 24 60 53 11 80 	movl   $0x80115360,(%esp)
8010491e:	e8 dd fd ff ff       	call   80104700 <acquire>
  struct pi_lock *lock = &pi_locks[id];
80104923:	69 75 08 10 01 00 00 	imul   $0x110,0x8(%ebp),%esi
  lock->used = 1;
8010492a:	83 c4 10             	add    $0x10,%esp
    l->waiters[l->waiter_count++] = p;
8010492d:	6b 45 08 44          	imul   $0x44,0x8(%ebp),%eax
  struct pi_lock *lock = &pi_locks[id];
80104931:	8d be a0 53 11 80    	lea    -0x7feeac60(%esi),%edi
    l->waiters[l->waiter_count++] = p;
80104937:	89 75 e4             	mov    %esi,-0x1c(%ebp)
  lock->used = 1;
8010493a:	c7 86 a0 53 11 80 01 	movl   $0x1,-0x7feeac60(%esi)
80104941:	00 00 00 

  for(;;){
    if(!lock->locked){
80104944:	8b 77 04             	mov    0x4(%edi),%esi
    l->waiters[l->waiter_count++] = p;
80104947:	89 45 e0             	mov    %eax,-0x20(%ebp)
    if(!lock->locked){
8010494a:	85 f6                	test   %esi,%esi
8010494c:	0f 84 e9 00 00 00    	je     80104a3b <pi_lock_acquire+0x14b>
80104952:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    ...
    if(lock->owner == cur){
80104958:	8b 4f 08             	mov    0x8(%edi),%ecx
8010495b:	8b 75 e4             	mov    -0x1c(%ebp),%esi
8010495e:	39 d9                	cmp    %ebx,%ecx
80104960:	0f 84 4c 01 00 00    	je     80104ab2 <pi_lock_acquire+0x1c2>
  for(i = 0; i < l->waiter_count; i++){
80104966:	8b 97 0c 01 00 00    	mov    0x10c(%edi),%edx
8010496c:	31 c0                	xor    %eax,%eax
8010496e:	85 d2                	test   %edx,%edx
80104970:	7f 19                	jg     8010498b <pi_lock_acquire+0x9b>
80104972:	e9 72 01 00 00       	jmp    80104ae9 <pi_lock_acquire+0x1f9>
80104977:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010497e:	00 
8010497f:	90                   	nop
80104980:	83 c0 01             	add    $0x1,%eax
80104983:	39 c2                	cmp    %eax,%edx
80104985:	0f 84 55 01 00 00    	je     80104ae0 <pi_lock_acquire+0x1f0>
    if(l->waiters[i] == p)
8010498b:	3b 9c 86 ac 53 11 80 	cmp    -0x7feeac54(%esi,%eax,4),%ebx
80104992:	75 ec                	jne    80104980 <pi_lock_acquire+0x90>
      release(&ptable.lock);
      return -1;
    }
...
80104994:	85 c9                	test   %ecx,%ecx
80104996:	74 14                	je     801049ac <pi_lock_acquire+0xbc>
80104998:	8b 83 90 00 00 00    	mov    0x90(%ebx),%eax
8010499e:	3b 81 90 00 00 00    	cmp    0x90(%ecx),%eax
801049a4:	7d 06                	jge    801049ac <pi_lock_acquire+0xbc>
      lock->owner->eff_nice = cur->eff_nice;
801049a6:	89 81 90 00 00 00    	mov    %eax,0x90(%ecx)
    }

    release(&pi_table_lock);
801049ac:	83 ec 0c             	sub    $0xc,%esp
801049af:	68 60 53 11 80       	push   $0x80115360
801049b4:	e8 e7 fc ff ff       	call   801046a0 <release>
    sleep(lock, &ptable.lock);
801049b9:	58                   	pop    %eax
801049ba:	5a                   	pop    %edx
801049bb:	68 20 2d 11 80       	push   $0x80112d20
801049c0:	57                   	push   %edi
801049c1:	e8 fa f6 ff ff       	call   801040c0 <sleep>
    acquire(&pi_table_lock);
801049c6:	c7 04 24 60 53 11 80 	movl   $0x80115360,(%esp)
801049cd:	e8 2e fd ff ff       	call   80104700 <acquire>
  for(i = 0; i < l->waiter_count; i++){
801049d2:	8b 97 0c 01 00 00    	mov    0x10c(%edi),%edx
801049d8:	83 c4 10             	add    $0x10,%esp
801049db:	85 d2                	test   %edx,%edx
801049dd:	0f 8e bd 00 00 00    	jle    80104aa0 <pi_lock_acquire+0x1b0>
801049e3:	31 c0                	xor    %eax,%eax
801049e5:	eb 14                	jmp    801049fb <pi_lock_acquire+0x10b>
801049e7:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801049ee:	00 
801049ef:	90                   	nop
801049f0:	83 c0 01             	add    $0x1,%eax
801049f3:	39 c2                	cmp    %eax,%edx
801049f5:	0f 84 a5 00 00 00    	je     80104aa0 <pi_lock_acquire+0x1b0>
    if(l->waiters[i] == p){
801049fb:	3b 9c 86 ac 53 11 80 	cmp    -0x7feeac54(%esi,%eax,4),%ebx
80104a02:	75 ec                	jne    801049f0 <pi_lock_acquire+0x100>
      l->waiters[i] = l->waiters[l->waiter_count];
80104a04:	8b 4d e0             	mov    -0x20(%ebp),%ecx
      l->waiter_count--;
80104a07:	83 ea 01             	sub    $0x1,%edx
80104a0a:	89 75 e4             	mov    %esi,-0x1c(%ebp)
80104a0d:	89 97 0c 01 00 00    	mov    %edx,0x10c(%edi)
      l->waiters[i] = l->waiters[l->waiter_count];
80104a13:	01 ca                	add    %ecx,%edx
80104a15:	01 c8                	add    %ecx,%eax
80104a17:	8b 34 95 ac 53 11 80 	mov    -0x7feeac54(,%edx,4),%esi
80104a1e:	89 34 85 ac 53 11 80 	mov    %esi,-0x7feeac54(,%eax,4)
    if(!lock->locked){
80104a25:	8b 77 04             	mov    0x4(%edi),%esi
      l->waiters[l->waiter_count] = 0;
80104a28:	c7 04 95 ac 53 11 80 	movl   $0x0,-0x7feeac54(,%edx,4)
80104a2f:	00 00 00 00 
    if(!lock->locked){
80104a33:	85 f6                	test   %esi,%esi
80104a35:	0f 85 1d ff ff ff    	jne    80104958 <pi_lock_acquire+0x68>
      lock->locked = 1;
80104a3b:	69 45 08 10 01 00 00 	imul   $0x110,0x8(%ebp),%eax
      cur->pi_mask |= (1 << id);
80104a42:	0f b6 4d 08          	movzbl 0x8(%ebp),%ecx
      lock->owner = cur;
80104a46:	89 98 a8 53 11 80    	mov    %ebx,-0x7feeac58(%eax)
      lock->locked = 1;
80104a4c:	c7 80 a4 53 11 80 01 	movl   $0x1,-0x7feeac5c(%eax)
80104a53:	00 00 00 
      lock->waiter_count = 0;
80104a56:	c7 80 ac 54 11 80 00 	movl   $0x0,-0x7feeab54(%eax)
80104a5d:	00 00 00 
      cur->pi_mask |= (1 << id);
80104a60:	b8 01 00 00 00       	mov    $0x1,%eax
80104a65:	d3 e0                	shl    %cl,%eax
80104a67:	09 83 94 00 00 00    	or     %eax,0x94(%ebx)
      recompute_proc_priority(cur);
80104a6d:	89 d8                	mov    %ebx,%eax
80104a6f:	e8 8c fd ff ff       	call   80104800 <recompute_proc_priority>
      release(&pi_table_lock);
80104a74:	83 ec 0c             	sub    $0xc,%esp
80104a77:	68 60 53 11 80       	push   $0x80115360
80104a7c:	e8 1f fc ff ff       	call   801046a0 <release>
      release(&ptable.lock);
80104a81:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80104a88:	e8 13 fc ff ff       	call   801046a0 <release>
      return 0;
...
80104a9a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(!lock->locked){
80104aa0:	8b 4f 04             	mov    0x4(%edi),%ecx
80104aa3:	85 c9                	test   %ecx,%ecx
80104aa5:	74 94                	je     80104a3b <pi_lock_acquire+0x14b>
    if(lock->owner == cur){
80104aa7:	8b 4f 08             	mov    0x8(%edi),%ecx
80104aaa:	39 d9                	cmp    %ebx,%ecx
80104aac:	0f 85 b4 fe ff ff    	jne    80104966 <pi_lock_acquire+0x76>
      release(&pi_table_lock);
80104ab2:	83 ec 0c             	sub    $0xc,%esp
80104ab5:	68 60 53 11 80       	push   $0x80115360
80104aba:	e8 e1 fb ff ff       	call   801046a0 <release>
      release(&ptable.lock);
80104abf:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80104ac6:	e8 d5 fb ff ff       	call   801046a0 <release>
      return -1;
...
80104ae0:	83 fa 40             	cmp    $0x40,%edx
80104ae3:	0f 84 ab fe ff ff    	je     80104994 <pi_lock_acquire+0xa4>
    l->waiters[l->waiter_count++] = p;
80104ae9:	8d 42 01             	lea    0x1(%edx),%eax
80104aec:	89 87 0c 01 00 00    	mov    %eax,0x10c(%edi)
80104af2:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104af5:	01 c2                	add    %eax,%edx
80104af7:	89 1c 95 ac 53 11 80 	mov    %ebx,-0x7feeac54(,%edx,4)
80104afe:	e9 91 fe ff ff       	jmp    80104994 <pi_lock_acquire+0xa4>
80104b03:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80104b0a:	00 
80104b0b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi

80104b10 <pi_lock_release>:
...
80104b19:	8b 7d 08             	mov    0x8(%ebp),%edi
  if(id < 0 || id >= MAX_PI_LOCKS)
80104b1c:	83 ff 06             	cmp    $0x6,%edi
80104b1f:	0f 87 af 00 00 00    	ja     80104bd4 <pi_lock_release+0xc4>
    return -1;

  struct proc *cur = myproc();
80104b25:	e8 66 ee ff ff       	call   80103990 <myproc>

  acquire(&ptable.lock);
80104b2a:	83 ec 0c             	sub    $0xc,%esp
80104b2d:	68 20 2d 11 80       	push   $0x80112d20
  struct proc *cur = myproc();
80104b32:	89 c3                	mov    %eax,%ebx
  acquire(&ptable.lock);
80104b34:	e8 c7 fb ff ff       	call   80104700 <acquire>
  acquire(&pi_table_lock);
80104b39:	c7 04 24 60 53 11 80 	movl   $0x80115360,(%esp)
80104b40:	e8 bb fb ff ff       	call   80104700 <acquire>
  struct pi_lock *lock = &pi_locks[id];
80104b45:	69 c7 10 01 00 00    	imul   $0x110,%edi,%eax

  if(!lock->locked || lock->owner != cur){
80104b4b:	83 c4 10             	add    $0x10,%esp
  struct pi_lock *lock = &pi_locks[id];
80104b4e:	8d b0 a0 53 11 80    	lea    -0x7feeac60(%eax),%esi
  if(!lock->locked || lock->owner != cur){
80104b54:	8b 80 a4 53 11 80    	mov    -0x7feeac5c(%eax),%eax
80104b5a:	85 c0                	test   %eax,%eax
80104b5c:	74 5a                	je     80104bb8 <pi_lock_release+0xa8>
80104b5e:	39 5e 08             	cmp    %ebx,0x8(%esi)
80104b61:	75 55                	jne    80104bb8 <pi_lock_release+0xa8>
    return -1;
  }
  ...
  lock->owner = 0;
  cur->pi_mask &= ~(1 << id);
80104b63:	89 f9                	mov    %edi,%ecx
80104b65:	b8 fe ff ff ff       	mov    $0xfffffffe,%eax
  lock->locked = 0;
80104b6a:	c7 46 04 00 00 00 00 	movl   $0x0,0x4(%esi)
  cur->pi_mask &= ~(1 << id);
80104b71:	d3 c0                	rol    %cl,%eax
  lock->owner = 0;
80104b73:	c7 46 08 00 00 00 00 	movl   $0x0,0x8(%esi)
  cur->pi_mask &= ~(1 << id);
80104b7a:	21 83 94 00 00 00    	and    %eax,0x94(%ebx)
  recompute_proc_priority(cur);
80104b80:	89 d8                	mov    %ebx,%eax
80104b82:	e8 79 fc ff ff       	call   80104800 <recompute_proc_priority>

  release(&pi_table_lock);
80104b87:	83 ec 0c             	sub    $0xc,%esp
80104b8a:	68 60 53 11 80       	push   $0x80115360
80104b8f:	e8 0c fb ff ff       	call   801046a0 <release>
  release(&ptable.lock);
80104b94:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80104b9b:	e8 00 fb ff ff       	call   801046a0 <release>
  wakeup(lock);
80104ba0:	89 34 24             	mov    %esi,(%esp)
80104ba3:	e8 d8 f5 ff ff       	call   80104180 <wakeup>
  return 0;
...
80104bbb:	68 60 53 11 80       	push   $0x80115360
80104bc0:	e8 db fa ff ff       	call   801046a0 <release>
    release(&ptable.lock);
80104bc5:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80104bcc:	e8 cf fa ff ff       	call   801046a0 <release>
    return -1;
80104bd1:	83 c4 10             	add    $0x10,%esp
    return -1;
80104bd4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104bd9:	eb d2                	jmp    80104bad <pi_lock_release+0x9d>
...
80104bea:	89 d0                	mov    %edx,%eax
80104bec:	09 c8                	or     %ecx,%eax
80104bee:	a8 03                	test   $0x3,%al
80104bf0:	75 1e                	jne    80104c10 <memset+0x30>
    c &= 0xFF;
80104bf2:	0f b6 45 0c          	movzbl 0xc(%ebp),%eax
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80104bf6:	c1 e9 02             	shr    $0x2,%ecx
  asm volatile("cld; rep stosl" :
80104bf9:	89 d7                	mov    %edx,%edi
80104bfb:	69 c0 01 01 01 01    	imul   $0x1010101,%eax,%eax
80104c01:	fc                   	cld
...
80104c07:	89 d0                	mov    %edx,%eax
80104c09:	c9                   	leave
80104c0a:	c3                   	ret
80104c0b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
  asm volatile("cld; rep stosb" :
80104c10:	8b 45 0c             	mov    0xc(%ebp),%eax
80104c13:	89 d7                	mov    %edx,%edi
80104c15:	fc                   	cld
80104c16:	f3 aa                	rep stos %al,%es:(%edi)
80104c18:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
80104c48:	74 16                	je     80104c60 <memcmp+0x40>
    if(*s1 != *s2)
80104c4a:	0f b6 08             	movzbl (%eax),%ecx
80104c4d:	0f b6 1a             	movzbl (%edx),%ebx
...
80104c77:	8b 45 10             	mov    0x10(%ebp),%eax
...
80104c82:	8d 0c 06             	lea    (%esi,%eax,1),%ecx
80104c85:	39 ca                	cmp    %ecx,%edx
80104c87:	73 1f                	jae    80104ca8 <memmove+0x38>
    s += n;
    d += n;
    while(n-- > 0)
80104c89:	85 c0                	test   %eax,%eax
80104c8b:	74 0f                	je     80104c9c <memmove+0x2c>
80104c8d:	83 e8 01             	sub    $0x1,%eax
      *--d = *--s;
...
80104ca2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    while(n-- > 0)
80104ca8:	8d 0c 06             	lea    (%esi,%eax,1),%ecx
...
80104cc1:	5d                   	pop    %ebp
80104cc2:	c3                   	ret
80104cc3:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80104cca:	00 
...
80104cea:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  while(n > 0 && *p && *p == *q)
80104ced:	85 d2                	test   %edx,%edx
80104cef:	75 16                	jne    80104d07 <strncmp+0x27>
80104cf1:	eb 2d                	jmp    80104d20 <strncmp+0x40>
80104cf3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
80104cf8:	3a 19                	cmp    (%ecx),%bl
80104cfa:	75 12                	jne    80104d0e <strncmp+0x2e>
    n--, p++, q++;
80104cfc:	83 c0 01             	add    $0x1,%eax
80104cff:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
80104d02:	83 ea 01             	sub    $0x1,%edx
80104d05:	74 19                	je     80104d20 <strncmp+0x40>
80104d07:	0f b6 18             	movzbl (%eax),%ebx
80104d0a:	84 db                	test   %bl,%bl
80104d0c:	75 ea                	jne    80104cf8 <strncmp+0x18>
  if(n == 0)
    return 0;
  return (uchar)*p - (uchar)*q;
80104d0e:	0f b6 00             	movzbl (%eax),%eax
80104d11:	0f b6 11             	movzbl (%ecx),%edx
}
80104d14:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104d17:	c9                   	leave
  return (uchar)*p - (uchar)*q;
80104d18:	29 d0                	sub    %edx,%eax
}
80104d1a:	c3                   	ret
...
80104d39:	8b 55 10             	mov    0x10(%ebp),%edx
  char *os;
...
80104d4a:	0f b6 4f ff          	movzbl -0x1(%edi),%ecx
80104d4e:	88 48 ff             	mov    %cl,-0x1(%eax)
80104d51:	84 c9                	test   %cl,%cl
80104d53:	74 13                	je     80104d68 <strncpy+0x38>
80104d55:	89 d3                	mov    %edx,%ebx
...
80104d65:	8d 76 00             	lea    0x0(%esi),%esi
  while(n-- > 0)
80104d68:	8d 0c 18             	lea    (%eax,%ebx,1),%ecx
80104d6b:	83 e9 01             	sub    $0x1,%ecx
80104d6e:	85 d2                	test   %edx,%edx
80104d70:	74 ec                	je     80104d5e <strncpy+0x2e>
80104d72:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    *s++ = 0;
80104d78:	83 c0 01             	add    $0x1,%eax
80104d7b:	89 ca                	mov    %ecx,%edx
80104d7d:	c6 40 ff 00          	movb   $0x0,-0x1(%eax)
  while(n-- > 0)
80104d81:	29 c2                	sub    %eax,%edx
80104d83:	85 d2                	test   %edx,%edx
80104d85:	7f f1                	jg     80104d78 <strncpy+0x48>
}
80104d87:	5b                   	pop    %ebx
80104d88:	89 f0                	mov    %esi,%eax
80104d8a:	5e                   	pop    %esi
80104d8b:	5f                   	pop    %edi
80104d8c:	5d                   	pop    %ebp
80104d8d:	c3                   	ret
...
80104e07:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104e0a:	e8 81 eb ff ff       	call   80103990 <myproc>

  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104e0f:	8b 40 04             	mov    0x4(%eax),%eax
80104e12:	39 c3                	cmp    %eax,%ebx
80104e14:	73 1a                	jae    80104e30 <fetchint+0x30>
80104e16:	8d 53 04             	lea    0x4(%ebx),%edx
80104e19:	39 d0                	cmp    %edx,%eax
80104e1b:	72 13                	jb     80104e30 <fetchint+0x30>
    return -1;
  *ip = *(int*)(addr);
80104e1d:	8b 45 0c             	mov    0xc(%ebp),%eax
80104e20:	8b 13                	mov    (%ebx),%edx
80104e22:	89 10                	mov    %edx,(%eax)
  return 0;
...
80104e35:	eb ef                	jmp    80104e26 <fetchint+0x26>
...
80104e47:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104e4a:	e8 41 eb ff ff       	call   80103990 <myproc>

  if(addr >= curproc->sz)
80104e4f:	3b 58 04             	cmp    0x4(%eax),%ebx
80104e52:	73 2c                	jae    80104e80 <fetchstr+0x40>
    return -1;
  *pp = (char*)addr;
80104e54:	8b 55 0c             	mov    0xc(%ebp),%edx
80104e57:	89 1a                	mov    %ebx,(%edx)
  ep = (char*)curproc->sz;
80104e59:	8b 50 04             	mov    0x4(%eax),%edx
  for(s = *pp; s < ep; s++){
80104e5c:	39 d3                	cmp    %edx,%ebx
80104e5e:	73 20                	jae    80104e80 <fetchstr+0x40>
80104e60:	89 d8                	mov    %ebx,%eax
80104e62:	eb 0b                	jmp    80104e6f <fetchstr+0x2f>
80104e64:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104e68:	83 c0 01             	add    $0x1,%eax
80104e6b:	39 d0                	cmp    %edx,%eax
80104e6d:	73 11                	jae    80104e80 <fetchstr+0x40>
    if(*s == 0)
...
80104e95:	e8 f6 ea ff ff       	call   80103990 <myproc>
...
80104ea3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104ea6:	e8 e5 ea ff ff       	call   80103990 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104eab:	8d 73 04             	lea    0x4(%ebx),%esi
  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104eae:	8b 40 04             	mov    0x4(%eax),%eax
80104eb1:	39 c6                	cmp    %eax,%esi
80104eb3:	73 1b                	jae    80104ed0 <argint+0x40>
80104eb5:	8d 53 08             	lea    0x8(%ebx),%edx
80104eb8:	39 d0                	cmp    %edx,%eax
80104eba:	72 14                	jb     80104ed0 <argint+0x40>
  *ip = *(int*)(addr);
80104ebc:	8b 45 0c             	mov    0xc(%ebp),%eax
80104ebf:	8b 53 04             	mov    0x4(%ebx),%edx
80104ec2:	89 10                	mov    %edx,(%eax)
  return 0;
...
80104ed0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104ed5:	eb ef                	jmp    80104ec6 <argint+0x36>
...
80104ee6:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
80104ee9:	e8 a2 ea ff ff       	call   80103990 <myproc>
80104eee:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104ef0:	e8 9b ea ff ff       	call   80103990 <myproc>
80104ef5:	8b 55 08             	mov    0x8(%ebp),%edx
80104ef8:	8b 40 1c             	mov    0x1c(%eax),%eax
80104efb:	8b 40 44             	mov    0x44(%eax),%eax
80104efe:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104f01:	e8 8a ea ff ff       	call   80103990 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104f06:	8d 7b 04             	lea    0x4(%ebx),%edi
  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104f09:	8b 40 04             	mov    0x4(%eax),%eax
80104f0c:	39 c7                	cmp    %eax,%edi
80104f0e:	73 30                	jae    80104f40 <argptr+0x60>
80104f10:	8d 4b 08             	lea    0x8(%ebx),%ecx
80104f13:	39 c8                	cmp    %ecx,%eax
80104f15:	72 29                	jb     80104f40 <argptr+0x60>
 
  if(argint(n, &i) < 0)
    return -1;
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
80104f17:	8b 55 10             	mov    0x10(%ebp),%edx
  *ip = *(int*)(addr);
80104f1a:	8b 43 04             	mov    0x4(%ebx),%eax
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
80104f1d:	85 d2                	test   %edx,%edx
80104f1f:	78 1f                	js     80104f40 <argptr+0x60>
80104f21:	8b 56 04             	mov    0x4(%esi),%edx
80104f24:	39 d0                	cmp    %edx,%eax
80104f26:	73 18                	jae    80104f40 <argptr+0x60>
80104f28:	8b 5d 10             	mov    0x10(%ebp),%ebx
80104f2b:	01 c3                	add    %eax,%ebx
80104f2d:	39 da                	cmp    %ebx,%edx
80104f2f:	72 0f                	jb     80104f40 <argptr+0x60>
    return -1;
  *pp = (char*)i;
80104f31:	8b 55 0c             	mov    0xc(%ebp),%edx
80104f34:	89 02                	mov    %eax,(%edx)
  return 0;
...
80104f45:	eb f1                	jmp    80104f38 <argptr+0x58>
...
80104f54:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104f55:	e8 36 ea ff ff       	call   80103990 <myproc>
...
80104f63:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104f66:	e8 25 ea ff ff       	call   80103990 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104f6b:	8d 73 04             	lea    0x4(%ebx),%esi
  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104f6e:	8b 40 04             	mov    0x4(%eax),%eax
80104f71:	39 c6                	cmp    %eax,%esi
80104f73:	73 43                	jae    80104fb8 <argstr+0x68>
80104f75:	8d 53 08             	lea    0x8(%ebx),%edx
80104f78:	39 d0                	cmp    %edx,%eax
80104f7a:	72 3c                	jb     80104fb8 <argstr+0x68>
  *ip = *(int*)(addr);
80104f7c:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104f7f:	e8 0c ea ff ff       	call   80103990 <myproc>
  if(addr >= curproc->sz)
80104f84:	3b 58 04             	cmp    0x4(%eax),%ebx
80104f87:	73 2f                	jae    80104fb8 <argstr+0x68>
  *pp = (char*)addr;
80104f89:	8b 55 0c             	mov    0xc(%ebp),%edx
80104f8c:	89 1a                	mov    %ebx,(%edx)
  ep = (char*)curproc->sz;
80104f8e:	8b 50 04             	mov    0x4(%eax),%edx
  for(s = *pp; s < ep; s++){
80104f91:	39 d3                	cmp    %edx,%ebx
80104f93:	73 23                	jae    80104fb8 <argstr+0x68>
80104f95:	89 d8                	mov    %ebx,%eax
80104f97:	eb 0e                	jmp    80104fa7 <argstr+0x57>
...
80104fbf:	5d                   	pop    %ebp
80104fc0:	c3                   	ret
80104fc1:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80104fc8:	00 
...
80104fd4:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104fd7:	e8 b4 e9 ff ff       	call   80103990 <myproc>
...
80105010:	50                   	push   %eax
            curproc->pid, curproc->name, num);
80105011:	8d 43 70             	lea    0x70(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
80105014:	50                   	push   %eax
80105015:	ff 73 14             	push   0x14(%ebx)
80105018:	68 52 7b 10 80       	push   $0x80107b52
8010501d:	e8 8e b6 ff ff       	call   801006b0 <cprintf>
    curproc->tf->eax = -1;
80105022:	8b 43 1c             	mov    0x1c(%ebx),%eax
...
80105055:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80105058:	57                   	push   %edi
80105059:	50                   	push   %eax
8010505a:	e8 41 d0 ff ff       	call   801020a0 <nameiparent>
...
8010506c:	e8 2f c7 ff ff       	call   801017a0 <ilock>
...
80105078:	e8 73 cc ff ff       	call   80101cf0 <dirlookup>
...
8010508a:	e8 a1 c9 ff ff       	call   80101a30 <iunlockput>
    ilock(ip);
8010508f:	89 34 24             	mov    %esi,(%esp)
80105092:	e8 09 c7 ff ff       	call   801017a0 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80105097:	83 c4 10             	add    $0x10,%esp
8010509a:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
8010509f:	75 17                	jne    801050b8 <create+0x78>
801050a1:	66 83 7e 50 02       	cmpw   $0x2,0x50(%esi)
...
801050da:	e8 51 c5 ff ff       	call   80101630 <ialloc>
801050df:	83 c4 10             	add    $0x10,%esp
801050e2:	89 c6                	mov    %eax,%esi
801050e4:	85 c0                	test   %eax,%eax
801050e6:	0f 84 bc 00 00 00    	je     801051a8 <create+0x168>
  ilock(ip);
801050ec:	83 ec 0c             	sub    $0xc,%esp
801050ef:	50                   	push   %eax
801050f0:	e8 ab c6 ff ff       	call   801017a0 <ilock>
  ip->major = major;
...
80105111:	e8 da c5 ff ff       	call   801016f0 <iupdate>
...
80105128:	e8 93 ce ff ff       	call   80101fc0 <dirlink>
8010512d:	83 c4 10             	add    $0x10,%esp
80105130:	85 c0                	test   %eax,%eax
80105132:	78 67                	js     8010519b <create+0x15b>
  iunlockput(dp);
80105134:	83 ec 0c             	sub    $0xc,%esp
80105137:	53                   	push   %ebx
80105138:	e8 f3 c8 ff ff       	call   80101a30 <iunlockput>
  return ip;
...
80105159:	e8 92 c5 ff ff       	call   801016f0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
8010515e:	83 c4 0c             	add    $0xc,%esp
80105161:	ff 76 04             	push   0x4(%esi)
80105164:	68 8a 7b 10 80       	push   $0x80107b8a
80105169:	56                   	push   %esi
8010516a:	e8 51 ce ff ff       	call   80101fc0 <dirlink>
...
8010517c:	68 89 7b 10 80       	push   $0x80107b89
80105181:	56                   	push   %esi
80105182:	e8 39 ce ff ff       	call   80101fc0 <dirlink>
...
80105191:	68 7d 7b 10 80       	push   $0x80107b7d
80105196:	e8 e5 b1 ff ff       	call   80100380 <panic>
    panic("create: dirlink");
8010519b:	83 ec 0c             	sub    $0xc,%esp
8010519e:	68 8c 7b 10 80       	push   $0x80107b8c
801051a3:	e8 d8 b1 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
801051a8:	83 ec 0c             	sub    $0xc,%esp
801051ab:	68 6e 7b 10 80       	push   $0x80107b6e
801051b0:	e8 cb b1 ff ff       	call   80100380 <panic>
...
801051e8:	8b 74 90 2c          	mov    0x2c(%eax,%edx,4),%esi
801051ec:	85 f6                	test   %esi,%esi
801051ee:	74 20                	je     80105210 <sys_dup+0x50>
  struct proc *curproc = myproc();
801051f0:	e8 9b e7 ff ff       	call   80103990 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105220:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
80105223:	89 74 98 2c          	mov    %esi,0x2c(%eax,%ebx,4)
  filedup(f);
80105227:	56                   	push   %esi
80105228:	e8 93 bc ff ff       	call   80100ec0 <filedup>
  return fd;
...
80105260:	e8 2b e7 ff ff       	call   80103990 <myproc>
...
801052a4:	e8 97 bd ff ff       	call   80101040 <fileread>
...
80105324:	e8 a7 bd ff ff       	call   801010d0 <filewrite>
...
8010536b:	8b 74 98 0c          	mov    0xc(%eax,%ebx,4),%esi
8010536f:	85 f6                	test   %esi,%esi
80105371:	74 25                	je     80105398 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80105373:	e8 18 e6 ff ff       	call   80103990 <myproc>
  fileclose(f);
80105378:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
8010537b:	c7 44 98 0c 00 00 00 	movl   $0x0,0xc(%eax,%ebx,4)
80105382:	00 
  fileclose(f);
...
801053c8:	8b 74 90 2c          	mov    0x2c(%eax,%edx,4),%esi
...
801053eb:	e8 00 bc ff ff       	call   80100ff0 <filestat>
...
80105442:	0f 88 e2 00 00 00    	js     8010552a <sys_link+0x11a>
  begin_op();
80105448:	e8 f3 d8 ff ff       	call   80102d40 <begin_op>
  if((ip = namei(old)) == 0){
8010544d:	83 ec 0c             	sub    $0xc,%esp
80105450:	ff 75 d4             	push   -0x2c(%ebp)
80105453:	e8 28 cc ff ff       	call   80102080 <namei>
...
80105469:	e8 32 c3 ff ff       	call   801017a0 <ilock>
  if(ip->type == T_DIR){
...
80105488:	e8 63 c2 ff ff       	call   801016f0 <iupdate>
  iunlock(ip);
8010548d:	89 1c 24             	mov    %ebx,(%esp)
80105490:	e8 eb c3 ff ff       	call   80101880 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80105495:	58                   	pop    %eax
80105496:	5a                   	pop    %edx
80105497:	57                   	push   %edi
80105498:	ff 75 d0             	push   -0x30(%ebp)
8010549b:	e8 00 cc ff ff       	call   801020a0 <nameiparent>
...
801054c3:	e8 f8 ca ff ff       	call   80101fc0 <dirlink>
...
801054d3:	e8 58 c5 ff ff       	call   80101a30 <iunlockput>
  iput(ip);
801054d8:	89 1c 24             	mov    %ebx,(%esp)
801054db:	e8 f0 c3 ff ff       	call   801018d0 <iput>
  end_op();
...
801054fc:	e8 2f c5 ff ff       	call   80101a30 <iunlockput>
    goto bad;
80105501:	83 c4 10             	add    $0x10,%esp
  ilock(ip);
80105504:	83 ec 0c             	sub    $0xc,%esp
80105507:	53                   	push   %ebx
80105508:	e8 93 c2 ff ff       	call   801017a0 <ilock>
  ip->nlink--;
8010550d:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80105512:	89 1c 24             	mov    %ebx,(%esp)
80105515:	e8 d6 c1 ff ff       	call   801016f0 <iupdate>
  iunlockput(ip);
8010551a:	89 1c 24             	mov    %ebx,(%esp)
8010551d:	e8 0e c5 ff ff       	call   80101a30 <iunlockput>
  end_op();
...
80105535:	e8 f6 c4 ff ff       	call   80101a30 <iunlockput>
    end_op();
8010553a:	e8 71 d8 ff ff       	call   80102db0 <end_op>
    return -1;
8010553f:	83 c4 10             	add    $0x10,%esp
80105542:	eb e6                	jmp    8010552a <sys_link+0x11a>
    end_op();
80105544:	e8 67 d8 ff ff       	call   80102db0 <end_op>
    return -1;
...
80105598:	e8 03 c2 ff ff       	call   801017a0 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
8010559d:	58                   	pop    %eax
8010559e:	5a                   	pop    %edx
8010559f:	68 8a 7b 10 80       	push   $0x80107b8a
801055a4:	53                   	push   %ebx
801055a5:	e8 26 c7 ff ff       	call   80101cd0 <namecmp>
...
801055b8:	68 89 7b 10 80       	push   $0x80107b89
801055bd:	53                   	push   %ebx
801055be:	e8 0d c7 ff ff       	call   80101cd0 <namecmp>
...
801055d7:	e8 14 c7 ff ff       	call   80101cf0 <dirlookup>
...
801055ed:	e8 ae c1 ff ff       	call   801017a0 <ilock>
  if(ip->nlink < 1)
801055f2:	83 c4 10             	add    $0x10,%esp
801055f5:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
801055fa:	0f 8e 0a 01 00 00    	jle    8010570a <sys_unlink+0x1ba>
...
80105620:	e8 8b c5 ff ff       	call   80101bb0 <writei>
80105625:	83 c4 20             	add    $0x20,%esp
80105628:	83 f8 10             	cmp    $0x10,%eax
8010562b:	0f 85 cc 00 00 00    	jne    801056fd <sys_unlink+0x1ad>
  if(ip->type == T_DIR){
...
80105642:	e8 e9 c3 ff ff       	call   80101a30 <iunlockput>
  ip->nlink--;
80105647:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
8010564c:	89 1c 24             	mov    %ebx,(%esp)
8010564f:	e8 9c c0 ff ff       	call   801016f0 <iupdate>
  iunlockput(ip);
80105654:	89 1c 24             	mov    %ebx,(%esp)
80105657:	e8 d4 c3 ff ff       	call   80101a30 <iunlockput>
  end_op();
8010565c:	e8 4f d7 ff ff       	call   80102db0 <end_op>
  return 0;
...
8010568d:	e8 1e c4 ff ff       	call   80101ab0 <readi>
...
801056a5:	e8 86 c3 ff ff       	call   80101a30 <iunlockput>
    goto bad;
...
801056b6:	e8 75 c3 ff ff       	call   80101a30 <iunlockput>
  end_op();
801056bb:	e8 f0 d6 ff ff       	call   80102db0 <end_op>
  return -1;
...
801056dc:	e8 0f c0 ff ff       	call   801016f0 <iupdate>
801056e1:	83 c4 10             	add    $0x10,%esp
801056e4:	e9 53 ff ff ff       	jmp    8010563c <sys_unlink+0xec>
    end_op();
801056e9:	e8 c2 d6 ff ff       	call   80102db0 <end_op>
    return -1;
801056ee:	eb d3                	jmp    801056c3 <sys_unlink+0x173>
      panic("isdirempty: readi");
801056f0:	83 ec 0c             	sub    $0xc,%esp
801056f3:	68 ae 7b 10 80       	push   $0x80107bae
801056f8:	e8 83 ac ff ff       	call   80100380 <panic>
    panic("unlink: writei");
801056fd:	83 ec 0c             	sub    $0xc,%esp
80105700:	68 c0 7b 10 80       	push   $0x80107bc0
80105705:	e8 76 ac ff ff       	call   80100380 <panic>
    panic("unlink: nlink < 1");
8010570a:	83 ec 0c             	sub    $0xc,%esp
8010570d:	68 9c 7b 10 80       	push   $0x80107b9c
80105712:	e8 69 ac ff ff       	call   80100380 <panic>
...
80105752:	78 79                	js     801057cd <sys_open+0xad>
  ...
  begin_op();
80105754:	e8 e7 d5 ff ff       	call   80102d40 <begin_op>
...
80105765:	e8 16 c9 ff ff       	call   80102080 <namei>
...
80105788:	0f 84 ba 00 00 00    	je     80105848 <sys_open+0x128>
      end_op();
      return -1;
    }
  }
...
80105797:	74 23                	je     801057bc <sys_open+0x9c>
  struct proc *curproc = myproc();
80105799:	e8 f2 e1 ff ff       	call   80103990 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
8010579e:	31 db                	xor    %ebx,%ebx
    if(curproc->ofile[fd] == 0){
801057a0:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
...
801057c0:	e8 6b c2 ff ff       	call   80101a30 <iunlockput>
    end_op();
801057c5:	e8 e6 d5 ff ff       	call   80102db0 <end_op>
    return -1;
...
801057e7:	e8 54 f8 ff ff       	call   80105040 <create>
    if(ip == 0){
...
801057f3:	75 99                	jne    8010578e <sys_open+0x6e>
      end_op();
801057f5:	e8 b6 d5 ff ff       	call   80102db0 <end_op>
      return -1;
801057fa:	eb d1                	jmp    801057cd <sys_open+0xad>
801057fc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  }
  iunlock(ip);
80105800:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
80105803:	89 7c 98 2c          	mov    %edi,0x2c(%eax,%ebx,4)
  iunlock(ip);
80105807:	56                   	push   %esi
80105808:	e8 73 c0 ff ff       	call   80101880 <iunlock>
  end_op();
8010580d:	e8 9e d5 ff ff       	call   80102db0 <end_op>

  f->type = FD_INODE;
80105812:	c7 07 02 00 00 00    	movl   $0x2,(%edi)
  f->ip = ip;
  f->off = 0;
...
8010581b:	83 c4 10             	add    $0x10,%esp
  f->ip = ip;
8010581e:	89 77 10             	mov    %esi,0x10(%edi)
  f->readable = !(omode & O_WRONLY);
80105821:	89 d0                	mov    %edx,%eax
  f->off = 0;
80105823:	c7 47 14 00 00 00 00 	movl   $0x0,0x14(%edi)
  f->readable = !(omode & O_WRONLY);
...
8010582f:	83 e2 03             	and    $0x3,%edx
  f->readable = !(omode & O_WRONLY);
80105832:	88 47 08             	mov    %al,0x8(%edi)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105835:	0f 95 47 09          	setne  0x9(%edi)
  return fd;
}
...
8010584d:	0f 84 3b ff ff ff    	je     8010578e <sys_open+0x6e>
...
80105863:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80105866:	e8 d5 d4 ff ff       	call   80102d40 <begin_op>
...
8010589f:	e8 8c c1 ff ff       	call   80101a30 <iunlockput>
  end_op();
801058a4:	e8 07 d5 ff ff       	call   80102db0 <end_op>
  return 0;
...
801058c3:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
801058c6:	e8 75 d4 ff ff       	call   80102d40 <begin_op>
  if((argstr(0, &path)) < 0 ||
...
8010592e:	e8 fd c0 ff ff       	call   80101a30 <iunlockput>
  end_op();
80105933:	e8 78 d4 ff ff       	call   80102db0 <end_op>
  return 0;
...
8010593f:	90                   	nop
    end_op();
80105940:	e8 6b d4 ff ff       	call   80102db0 <end_op>
    return -1;
...
80105955:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105958:	e8 33 e0 ff ff       	call   80103990 <myproc>
8010595d:	89 c6                	mov    %eax,%esi
  
  begin_op();
8010595f:	e8 dc d3 ff ff       	call   80102d40 <begin_op>
...
8010597f:	e8 fc c6 ff ff       	call   80102080 <namei>
...
801059a4:	e8 d7 be ff ff       	call   80101880 <iunlock>
  iput(curproc->cwd);
801059a9:	58                   	pop    %eax
801059aa:	ff 76 6c             	push   0x6c(%esi)
801059ad:	e8 1e bf ff ff       	call   801018d0 <iput>
  end_op();
801059b2:	e8 f9 d3 ff ff       	call   80102db0 <end_op>
  curproc->cwd = ip;
801059b7:	89 5e 6c             	mov    %ebx,0x6c(%esi)
  return 0;
...
801059d4:	e8 57 c0 ff ff       	call   80101a30 <iunlockput>
    end_op();
801059d9:	e8 d2 d3 ff ff       	call   80102db0 <end_op>
    return -1;
...
801059ef:	00 
    end_op();
801059f0:	e8 bb d3 ff ff       	call   80102db0 <end_op>
    return -1;
...
80105a50:	e8 8b f1 ff ff       	call   80104be0 <memset>
...
80105a7a:	e8 81 f3 ff ff       	call   80104e00 <fetchint>
...
80105a98:	e8 a3 f3 ff ff       	call   80104e40 <fetchstr>
...
80105ad5:	e8 d6 af ff ff       	call   80100ab0 <exec>
...
80105b0b:	0f 88 8b 00 00 00    	js     80105b9c <sys_pipe+0xac>
    return -1;
...
80105b1c:	e8 ef d8 ff ff       	call   80103410 <pipealloc>
80105b21:	83 c4 10             	add    $0x10,%esp
80105b24:	85 c0                	test   %eax,%eax
80105b26:	78 74                	js     80105b9c <sys_pipe+0xac>
    return -1;
  fd0 = -1;
...
80105b2d:	e8 5e de ff ff       	call   80103990 <myproc>
    if(curproc->ofile[fd] == 0){
80105b32:	8b 74 98 2c          	mov    0x2c(%eax,%ebx,4),%esi
...
80105b46:	74 3d                	je     80105b85 <sys_pipe+0x95>
    if(curproc->ofile[fd] == 0){
80105b48:	8b 74 98 2c          	mov    0x2c(%eax,%ebx,4),%esi
80105b4c:	85 f6                	test   %esi,%esi
80105b4e:	75 f0                	jne    80105b40 <sys_pipe+0x50>
      curproc->ofile[fd] = f;
80105b50:	8d 73 08             	lea    0x8(%ebx),%esi
80105b53:	89 7c b0 0c          	mov    %edi,0xc(%eax,%esi,4)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80105b57:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
80105b5a:	e8 31 de ff ff       	call   80103990 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
80105b5f:	31 d2                	xor    %edx,%edx
80105b61:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(curproc->ofile[fd] == 0){
80105b68:	8b 4c 90 2c          	mov    0x2c(%eax,%edx,4),%ecx
80105b6c:	85 c9                	test   %ecx,%ecx
80105b6e:	74 38                	je     80105ba8 <sys_pipe+0xb8>
  for(fd = 0; fd < NOFILE; fd++){
80105b70:	83 c2 01             	add    $0x1,%edx
80105b73:	83 fa 10             	cmp    $0x10,%edx
80105b76:	75 f0                	jne    80105b68 <sys_pipe+0x78>
    if(fd0 >= 0)
      myproc()->ofile[fd0] = 0;
80105b78:	e8 13 de ff ff       	call   80103990 <myproc>
80105b7d:	c7 44 b0 0c 00 00 00 	movl   $0x0,0xc(%eax,%esi,4)
80105b84:	00 
    fileclose(rf);
80105b85:	83 ec 0c             	sub    $0xc,%esp
80105b88:	ff 75 e0             	push   -0x20(%ebp)
80105b8b:	e8 80 b3 ff ff       	call   80100f10 <fileclose>
    fileclose(wf);
80105b90:	58                   	pop    %eax
80105b91:	ff 75 e4             	push   -0x1c(%ebp)
80105b94:	e8 77 b3 ff ff       	call   80100f10 <fileclose>
    return -1;
80105b99:	83 c4 10             	add    $0x10,%esp
    return -1;
80105b9c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ba1:	eb 16                	jmp    80105bb9 <sys_pipe+0xc9>
80105ba3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
      curproc->ofile[fd] = f;
80105ba8:	89 7c 90 2c          	mov    %edi,0x2c(%eax,%edx,4)
  }
  fd[0] = fd0;
...
{
  return fork();
80105bd0:	e9 5b df ff ff       	jmp    80103b30 <fork>
...
80105be3:	83 ec 08             	sub    $0x8,%esp
  exit();
80105be6:	e8 25 e2 ff ff       	call   80103e10 <exit>
...
{
  return wait();
80105bf0:	e9 4b e3 ff ff       	jmp    80103f40 <wait>
...
80105c1e:	e8 bd e5 ff ff       	call   801041e0 <kill>
...
80105c43:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105c46:	e8 45 dd ff ff       	call   80103990 <myproc>
...
80105c6e:	83 ec 0c             	sub    $0xc,%esp
  addr = myproc()->sz;
80105c71:	8b 58 04             	mov    0x4(%eax),%ebx
  if(growproc(n) < 0)
80105c74:	ff 75 f4             	push   -0xc(%ebp)
80105c77:	e8 34 de ff ff       	call   80103ab0 <growproc>
80105c7c:	83 c4 10             	add    $0x10,%esp
80105c7f:	85 c0                	test   %eax,%eax
80105c81:	78 0d                	js     80105c90 <sys_sbrk+0x40>
    return -1;
  return addr;
}
...
80105c95:	eb ec                	jmp    80105c83 <sys_sbrk+0x33>
...
80105cbc:	68 40 5b 11 80       	push   $0x80115b40
80105cc1:	e8 3a ea ff ff       	call   80104700 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105cc6:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105cc9:	8b 1d 20 5b 11 80    	mov    0x80115b20,%ebx
  while(ticks - ticks0 < n){
80105ccf:	83 c4 10             	add    $0x10,%esp
80105cd2:	85 d2                	test   %edx,%edx
80105cd4:	75 2b                	jne    80105d01 <sys_sleep+0x61>
80105cd6:	eb 58                	jmp    80105d30 <sys_sleep+0x90>
...
80105ce3:	68 40 5b 11 80       	push   $0x80115b40
80105ce8:	68 20 5b 11 80       	push   $0x80115b20
80105ced:	e8 ce e3 ff ff       	call   801040c0 <sleep>
  while(ticks - ticks0 < n){
80105cf2:	a1 20 5b 11 80       	mov    0x80115b20,%eax
...
80105cff:	73 2f                	jae    80105d30 <sys_sleep+0x90>
    if(myproc()->killed){
80105d01:	e8 8a dc ff ff       	call   80103990 <myproc>
80105d06:	8b 40 28             	mov    0x28(%eax),%eax
80105d09:	85 c0                	test   %eax,%eax
80105d0b:	74 d3                	je     80105ce0 <sys_sleep+0x40>
      release(&tickslock);
80105d0d:	83 ec 0c             	sub    $0xc,%esp
80105d10:	68 40 5b 11 80       	push   $0x80115b40
80105d15:	e8 86 e9 ff ff       	call   801046a0 <release>
      return -1;
...
80105d33:	68 40 5b 11 80       	push   $0x80115b40
80105d38:	e8 63 e9 ff ff       	call   801046a0 <release>
}
...
80105d54:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105d57:	68 40 5b 11 80       	push   $0x80115b40
80105d5c:	e8 9f e9 ff ff       	call   80104700 <acquire>
  xticks = ticks;
80105d61:	8b 1d 20 5b 11 80    	mov    0x80115b20,%ebx
  release(&tickslock);
80105d67:	c7 04 24 40 5b 11 80 	movl   $0x80115b40,(%esp)
80105d6e:	e8 2d e9 ff ff       	call   801046a0 <release>
  return xticks;
}
...
80105d96:	78 18                	js     80105db0 <sys_lock+0x30>
  return pi_lock_acquire(id);
80105d98:	83 ec 0c             	sub    $0xc,%esp
80105d9b:	ff 75 f4             	push   -0xc(%ebp)
80105d9e:	e8 4d eb ff ff       	call   801048f0 <pi_lock_acquire>
...
80105dd6:	78 18                	js     80105df0 <sys_release+0x30>
  return pi_lock_release(id);
80105dd8:	83 ec 0c             	sub    $0xc,%esp
80105ddb:	ff 75 f4             	push   -0xc(%ebp)
80105dde:	e8 2d ed ff ff       	call   80104b10 <pi_lock_release>
...
80105e0c:	e8 7f f0 ff ff       	call   80104e90 <argint>
80105e11:	83 c4 10             	add    $0x10,%esp
80105e14:	85 c0                	test   %eax,%eax
80105e16:	78 28                	js     80105e40 <sys_setnice+0x40>
    return -1;
  if (argint(1, &value) < 0)
...
80105e21:	e8 6a f0 ff ff       	call   80104e90 <argint>
80105e26:	83 c4 10             	add    $0x10,%esp
80105e29:	85 c0                	test   %eax,%eax
80105e2b:	78 13                	js     80105e40 <sys_setnice+0x40>
    return -1;
  return setnice(pid, value);
80105e2d:	83 ec 08             	sub    $0x8,%esp
80105e30:	ff 75 f4             	push   -0xc(%ebp)
80105e33:	ff 75 f0             	push   -0x10(%ebp)
80105e36:	e8 e5 e4 ff ff       	call   80104320 <setnice>
...
80105e46:	c3                   	ret
80105e47:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80105e4e:	00 
80105e4f:	90                   	nop

80105e50 <sys_getnice>:
...
80105e5c:	e8 2f f0 ff ff       	call   80104e90 <argint>
80105e61:	83 c4 10             	add    $0x10,%esp
80105e64:	85 c0                	test   %eax,%eax
80105e66:	78 18                	js     80105e80 <sys_getnice+0x30>
    return -1;
  return getnice(pid);
80105e68:	83 ec 0c             	sub    $0xc,%esp
80105e6b:	ff 75 f4             	push   -0xc(%ebp)
80105e6e:	e8 2d e5 ff ff       	call   801043a0 <getnice>
...
80105ec0:	8b 14 85 0c b0 10 80 	mov    -0x7fef4ff4(,%eax,4),%edx
80105ec7:	c7 04 c5 82 5b 11 80 	movl   $0x8e000008,-0x7feea47e(,%eax,8)
80105ece:	08 00 00 8e 
80105ed2:	66 89 14 c5 80 5b 11 	mov    %dx,-0x7feea480(,%eax,8)
80105ed9:	80 
80105eda:	c1 ea 10             	shr    $0x10,%edx
80105edd:	66 89 14 c5 86 5b 11 	mov    %dx,-0x7feea47a(,%eax,8)
80105ee4:	80 
  for(i = 0; i < 256; i++)
...
80105eef:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105ef2:	a1 0c b1 10 80       	mov    0x8010b10c,%eax
80105ef7:	c7 05 82 5d 11 80 08 	movl   $0xef000008,0x80115d82
80105efe:	00 00 ef 
  initlock(&tickslock, "time");
80105f01:	68 cf 7b 10 80       	push   $0x80107bcf
80105f06:	68 40 5b 11 80       	push   $0x80115b40
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105f0b:	66 a3 80 5d 11 80    	mov    %ax,0x80115d80
80105f11:	c1 e8 10             	shr    $0x10,%eax
80105f14:	66 a3 86 5d 11 80    	mov    %ax,0x80115d86
  initlock(&tickslock, "time");
80105f1a:	e8 f1 e5 ff ff       	call   80104510 <initlock>
}
80105f1f:	83 c4 10             	add    $0x10,%esp
80105f22:	c9                   	leave
80105f23:	c3                   	ret
80105f24:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80105f2b:	00 
...
80105f3b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105f3f:	b8 80 5b 11 80       	mov    $0x80115b80,%eax
...
80105f7e:	77 70                	ja     80105ff0 <trap+0x90>
80105f80:	ff 24 85 48 81 10 80 	jmp    *-0x7fef7eb8(,%eax,4)
...
80105f8f:	90                   	nop
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80105f90:	e8 9b c2 ff ff       	call   80102230 <ideintr>
    lapiceoi();
80105f95:	e8 56 c9 ff ff       	call   801028f0 <lapiceoi>
...
80105f9a:	e8 f1 d9 ff ff       	call   80103990 <myproc>
80105f9f:	85 c0                	test   %eax,%eax
80105fa1:	74 1a                	je     80105fbd <trap+0x5d>
80105fa3:	e8 e8 d9 ff ff       	call   80103990 <myproc>
80105fa8:	8b 50 28             	mov    0x28(%eax),%edx
80105fab:	85 d2                	test   %edx,%edx
80105fad:	74 0e                	je     80105fbd <trap+0x5d>
80105faf:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105fb3:	f7 d0                	not    %eax
80105fb5:	a8 03                	test   $0x3,%al
80105fb7:	0f 84 c3 01 00 00    	je     80106180 <trap+0x220>
    exit();

  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105fbd:	e8 ce d9 ff ff       	call   80103990 <myproc>
80105fc2:	85 c0                	test   %eax,%eax
80105fc4:	74 1a                	je     80105fe0 <trap+0x80>
80105fc6:	e8 c5 d9 ff ff       	call   80103990 <myproc>
80105fcb:	8b 40 28             	mov    0x28(%eax),%eax
80105fce:	85 c0                	test   %eax,%eax
80105fd0:	74 0e                	je     80105fe0 <trap+0x80>
80105fd2:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105fd6:	f7 d0                	not    %eax
80105fd8:	a8 03                	test   $0x3,%al
80105fda:	0f 84 f5 00 00 00    	je     801060d5 <trap+0x175>
    exit();
}
...
80105ff5:	8b 7b 38             	mov    0x38(%ebx),%edi
80105ff8:	85 c0                	test   %eax,%eax
80105ffa:	0f 84 d2 01 00 00    	je     801061d2 <trap+0x272>
80106000:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80106004:	0f 84 c8 01 00 00    	je     801061d2 <trap+0x272>
...
80106010:	e8 5b d9 ff ff       	call   80103970 <cpuid>
80106015:	8b 73 30             	mov    0x30(%ebx),%esi
80106018:	89 45 dc             	mov    %eax,-0x24(%ebp)
8010601b:	8b 43 34             	mov    0x34(%ebx),%eax
8010601e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            myproc()->pid, myproc()->name, tf->trapno,
80106021:	e8 6a d9 ff ff       	call   80103990 <myproc>
80106026:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106029:	e8 62 d9 ff ff       	call   80103990 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010602e:	8b 4d d8             	mov    -0x28(%ebp),%ecx
80106031:	51                   	push   %ecx
80106032:	57                   	push   %edi
80106033:	8b 55 dc             	mov    -0x24(%ebp),%edx
80106036:	52                   	push   %edx
80106037:	ff 75 e4             	push   -0x1c(%ebp)
8010603a:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
8010603b:	8b 75 e0             	mov    -0x20(%ebp),%esi
8010603e:	83 c6 70             	add    $0x70,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106041:	56                   	push   %esi
80106042:	ff 70 14             	push   0x14(%eax)
80106045:	68 20 7e 10 80       	push   $0x80107e20
8010604a:	e8 61 a6 ff ff       	call   801006b0 <cprintf>
    myproc()->killed = 1;
8010604f:	83 c4 20             	add    $0x20,%esp
80106052:	e8 39 d9 ff ff       	call   80103990 <myproc>
80106057:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010605e:	e8 2d d9 ff ff       	call   80103990 <myproc>
80106063:	85 c0                	test   %eax,%eax
80106065:	0f 85 38 ff ff ff    	jne    80105fa3 <trap+0x43>
8010606b:	e9 4d ff ff ff       	jmp    80105fbd <trap+0x5d>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106070:	8b 7b 38             	mov    0x38(%ebx),%edi
80106073:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80106077:	e8 f4 d8 ff ff       	call   80103970 <cpuid>
8010607c:	57                   	push   %edi
8010607d:	56                   	push   %esi
8010607e:	50                   	push   %eax
8010607f:	68 c8 7d 10 80       	push   $0x80107dc8
80106084:	e8 27 a6 ff ff       	call   801006b0 <cprintf>
    lapiceoi();
80106089:	e8 62 c8 ff ff       	call   801028f0 <lapiceoi>
    break;
8010608e:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106091:	e8 fa d8 ff ff       	call   80103990 <myproc>
80106096:	85 c0                	test   %eax,%eax
80106098:	0f 85 05 ff ff ff    	jne    80105fa3 <trap+0x43>
8010609e:	e9 1a ff ff ff       	jmp    80105fbd <trap+0x5d>
801060a3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
801060a8:	e8 e3 d8 ff ff       	call   80103990 <myproc>
801060ad:	8b 70 28             	mov    0x28(%eax),%esi
801060b0:	85 f6                	test   %esi,%esi
801060b2:	0f 85 10 01 00 00    	jne    801061c8 <trap+0x268>
    myproc()->tf = tf;
801060b8:	e8 d3 d8 ff ff       	call   80103990 <myproc>
801060bd:	89 58 1c             	mov    %ebx,0x1c(%eax)
    syscall();
801060c0:	e8 0b ef ff ff       	call   80104fd0 <syscall>
    if(myproc()->killed)
801060c5:	e8 c6 d8 ff ff       	call   80103990 <myproc>
801060ca:	8b 48 28             	mov    0x28(%eax),%ecx
801060cd:	85 c9                	test   %ecx,%ecx
801060cf:	0f 84 0b ff ff ff    	je     80105fe0 <trap+0x80>
}
...
801060db:	5d                   	pop    %ebp
      exit();
801060dc:	e9 2f dd ff ff       	jmp    80103e10 <exit>
801060e1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
801060e8:	e8 93 02 00 00       	call   80106380 <uartintr>
    lapiceoi();
801060ed:	e8 fe c7 ff ff       	call   801028f0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801060f2:	e8 99 d8 ff ff       	call   80103990 <myproc>
801060f7:	85 c0                	test   %eax,%eax
801060f9:	0f 85 a4 fe ff ff    	jne    80105fa3 <trap+0x43>
801060ff:	e9 b9 fe ff ff       	jmp    80105fbd <trap+0x5d>
80106104:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80106108:	e8 b3 c6 ff ff       	call   801027c0 <kbdintr>
    lapiceoi();
8010610d:	e8 de c7 ff ff       	call   801028f0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106112:	e8 79 d8 ff ff       	call   80103990 <myproc>
80106117:	85 c0                	test   %eax,%eax
80106119:	0f 85 84 fe ff ff    	jne    80105fa3 <trap+0x43>
8010611f:	e9 99 fe ff ff       	jmp    80105fbd <trap+0x5d>
80106124:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(cpuid() == 0){
80106128:	e8 43 d8 ff ff       	call   80103970 <cpuid>
8010612d:	85 c0                	test   %eax,%eax
8010612f:	74 5f                	je     80106190 <trap+0x230>
  struct proc *p = myproc();
80106131:	e8 5a d8 ff ff       	call   80103990 <myproc>
  if(p && p->state == RUNNING){
80106136:	85 c0                	test   %eax,%eax
80106138:	0f 84 57 fe ff ff    	je     80105f95 <trap+0x35>
8010613e:	83 78 10 04          	cmpl   $0x4,0x10(%eax)
80106142:	0f 85 4d fe ff ff    	jne    80105f95 <trap+0x35>
    p->ticks++;
80106148:	8b b8 84 00 00 00    	mov    0x84(%eax),%edi
    int yield_interval = 5 + p->eff_nice * 5; // nice 越高 yield 越频繁
8010614e:	8b 88 90 00 00 00    	mov    0x90(%eax),%ecx
    p->ticks++;
80106154:	8d 57 01             	lea    0x1(%edi),%edx
    int yield_interval = 5 + p->eff_nice * 5; // nice 越高 yield 越频繁
80106157:	8d 4c 89 05          	lea    0x5(%ecx,%ecx,4),%ecx
    p->ticks++;
8010615b:	89 90 84 00 00 00    	mov    %edx,0x84(%eax)
    if(p->ticks >= yield_interval){
80106161:	39 ca                	cmp    %ecx,%edx
80106163:	0f 8c 2c fe ff ff    	jl     80105f95 <trap+0x35>
      p->ticks = 0;
80106169:	c7 80 84 00 00 00 00 	movl   $0x0,0x84(%eax)
80106170:	00 00 00 
      yield();
80106173:	e8 f8 de ff ff       	call   80104070 <yield>
  lapiceoi();
80106178:	e9 18 fe ff ff       	jmp    80105f95 <trap+0x35>
8010617d:	8d 76 00             	lea    0x0(%esi),%esi
    exit();
80106180:	e8 8b dc ff ff       	call   80103e10 <exit>
80106185:	e9 33 fe ff ff       	jmp    80105fbd <trap+0x5d>
8010618a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    acquire(&tickslock);
80106190:	83 ec 0c             	sub    $0xc,%esp
80106193:	68 40 5b 11 80       	push   $0x80115b40
80106198:	e8 63 e5 ff ff       	call   80104700 <acquire>
    ticks++;
8010619d:	83 05 20 5b 11 80 01 	addl   $0x1,0x80115b20
    wakeup(&ticks);
801061a4:	c7 04 24 20 5b 11 80 	movl   $0x80115b20,(%esp)
801061ab:	e8 d0 df ff ff       	call   80104180 <wakeup>
    release(&tickslock);
801061b0:	c7 04 24 40 5b 11 80 	movl   $0x80115b40,(%esp)
801061b7:	e8 e4 e4 ff ff       	call   801046a0 <release>
801061bc:	83 c4 10             	add    $0x10,%esp
801061bf:	e9 6d ff ff ff       	jmp    80106131 <trap+0x1d1>
801061c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      exit();
801061c8:	e8 43 dc ff ff       	call   80103e10 <exit>
801061cd:	e9 e6 fe ff ff       	jmp    801060b8 <trap+0x158>
801061d2:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801061d5:	e8 96 d7 ff ff       	call   80103970 <cpuid>
801061da:	83 ec 0c             	sub    $0xc,%esp
801061dd:	56                   	push   %esi
801061de:	57                   	push   %edi
801061df:	50                   	push   %eax
801061e0:	ff 73 30             	push   0x30(%ebx)
801061e3:	68 ec 7d 10 80       	push   $0x80107dec
801061e8:	e8 c3 a4 ff ff       	call   801006b0 <cprintf>
      panic("trap");
801061ed:	83 c4 14             	add    $0x14,%esp
801061f0:	68 d4 7b 10 80       	push   $0x80107bd4
801061f5:	e8 86 a1 ff ff       	call   80100380 <panic>
...
{
  if(!uart)
80106200:	a1 80 63 11 80       	mov    0x80116380,%eax
...
80106225:	c3                   	ret
80106226:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010622d:	00 
...
80106287:	0f 84 7c 00 00 00    	je     80106309 <uartinit+0xd9>
  uart = 1;
8010628d:	c7 05 80 63 11 80 01 	movl   $0x1,0x80116380
80106294:	00 00 00 
80106297:	89 fa                	mov    %edi,%edx
...
801062a0:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
801062a3:	bf d9 7b 10 80       	mov    $0x80107bd9,%edi
801062a8:	be fd 03 00 00       	mov    $0x3fd,%esi
  ioapicenable(IRQ_COM1, 0);
801062ad:	6a 00                	push   $0x0
801062af:	6a 04                	push   $0x4
801062b1:	e8 aa c1 ff ff       	call   80102460 <ioapicenable>
801062b6:	83 c4 10             	add    $0x10,%esp
  for(p="xv6...\n"; *p; p++)
801062b9:	c6 45 e7 78          	movb   $0x78,-0x19(%ebp)
801062bd:	8d 76 00             	lea    0x0(%esi),%esi
  if(!uart)
801062c0:	a1 80 63 11 80       	mov    0x80116380,%eax
801062c5:	85 c0                	test   %eax,%eax
801062c7:	74 32                	je     801062fb <uartinit+0xcb>
801062c9:	89 f2                	mov    %esi,%edx
801062cb:	ec                   	in     (%dx),%al
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801062cc:	a8 20                	test   $0x20,%al
801062ce:	75 21                	jne    801062f1 <uartinit+0xc1>
801062d0:	bb 80 00 00 00       	mov    $0x80,%ebx
801062d5:	8d 76 00             	lea    0x0(%esi),%esi
    microdelay(10);
801062d8:	83 ec 0c             	sub    $0xc,%esp
801062db:	6a 0a                	push   $0xa
801062dd:	e8 2e c6 ff ff       	call   80102910 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801062e2:	83 c4 10             	add    $0x10,%esp
801062e5:	83 eb 01             	sub    $0x1,%ebx
801062e8:	74 07                	je     801062f1 <uartinit+0xc1>
801062ea:	89 f2                	mov    %esi,%edx
801062ec:	ec                   	in     (%dx),%al
801062ed:	a8 20                	test   $0x20,%al
801062ef:	74 e7                	je     801062d8 <uartinit+0xa8>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801062f1:	ba f8 03 00 00       	mov    $0x3f8,%edx
801062f6:	0f b6 45 e7          	movzbl -0x19(%ebp),%eax
801062fa:	ee                   	out    %al,(%dx)
  for(p="xv6...\n"; *p; p++)
801062fb:	0f b6 47 01          	movzbl 0x1(%edi),%eax
801062ff:	83 c7 01             	add    $0x1,%edi
80106302:	88 45 e7             	mov    %al,-0x19(%ebp)
80106305:	84 c0                	test   %al,%al
80106307:	75 b7                	jne    801062c0 <uartinit+0x90>
}
...
8010630f:	5d                   	pop    %ebp
80106310:	c3                   	ret
80106311:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80106318:	00 
80106319:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80106320 <uartputc>:
  if(!uart)
80106320:	a1 80 63 11 80       	mov    0x80116380,%eax
80106325:	85 c0                	test   %eax,%eax
80106327:	74 4f                	je     80106378 <uartputc+0x58>
{
80106329:	55                   	push   %ebp
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
8010632a:	ba fd 03 00 00       	mov    $0x3fd,%edx
8010632f:	89 e5                	mov    %esp,%ebp
80106331:	56                   	push   %esi
80106332:	53                   	push   %ebx
80106333:	ec                   	in     (%dx),%al
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106334:	a8 20                	test   $0x20,%al
80106336:	75 29                	jne    80106361 <uartputc+0x41>
...
8010634b:	6a 0a                	push   $0xa
8010634d:	e8 be c5 ff ff       	call   80102910 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106352:	83 c4 10             	add    $0x10,%esp
80106355:	83 eb 01             	sub    $0x1,%ebx
80106358:	74 07                	je     80106361 <uartputc+0x41>
8010635a:	89 f2                	mov    %esi,%edx
8010635c:	ec                   	in     (%dx),%al
8010635d:	a8 20                	test   $0x20,%al
8010635f:	74 e7                	je     80106348 <uartputc+0x28>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106361:	8b 45 08             	mov    0x8(%ebp),%eax
80106364:	ba f8 03 00 00       	mov    $0x3f8,%edx
...
80106386:	68 00 62 10 80       	push   $0x80106200
8010638b:	e8 10 a5 ff ff       	call   801008a0 <consoleintr>
}
...
80106397:	6a 00                	push   $0x0
  jmp alltraps
80106399:	e9 e9 fa ff ff       	jmp    80105e87 <alltraps>
...
801063a0:	6a 01                	push   $0x1
  jmp alltraps
801063a2:	e9 e0 fa ff ff       	jmp    80105e87 <alltraps>
...
801063a9:	6a 02                	push   $0x2
  jmp alltraps
801063ab:	e9 d7 fa ff ff       	jmp    80105e87 <alltraps>
...
801063b2:	6a 03                	push   $0x3
  jmp alltraps
801063b4:	e9 ce fa ff ff       	jmp    80105e87 <alltraps>
...
801063bb:	6a 04                	push   $0x4
  jmp alltraps
801063bd:	e9 c5 fa ff ff       	jmp    80105e87 <alltraps>
...
801063c4:	6a 05                	push   $0x5
  jmp alltraps
801063c6:	e9 bc fa ff ff       	jmp    80105e87 <alltraps>
...
801063cd:	6a 06                	push   $0x6
  jmp alltraps
801063cf:	e9 b3 fa ff ff       	jmp    80105e87 <alltraps>
...
801063d6:	6a 07                	push   $0x7
  jmp alltraps
801063d8:	e9 aa fa ff ff       	jmp    80105e87 <alltraps>
...
801063dd:	6a 08                	push   $0x8
  jmp alltraps
801063df:	e9 a3 fa ff ff       	jmp    80105e87 <alltraps>
...
801063e6:	6a 09                	push   $0x9
  jmp alltraps
801063e8:	e9 9a fa ff ff       	jmp    80105e87 <alltraps>
...
801063ed:	6a 0a                	push   $0xa
  jmp alltraps
801063ef:	e9 93 fa ff ff       	jmp    80105e87 <alltraps>
...
801063f4:	6a 0b                	push   $0xb
  jmp alltraps
801063f6:	e9 8c fa ff ff       	jmp    80105e87 <alltraps>
...
80106402:	6a 0d                	push   $0xd
  jmp alltraps
80106404:	e9 7e fa ff ff       	jmp    80105e87 <alltraps>
...
80106409:	6a 0e                	push   $0xe
  jmp alltraps
8010640b:	e9 77 fa ff ff       	jmp    80105e87 <alltraps>
...
80106412:	6a 0f                	push   $0xf
  jmp alltraps
80106414:	e9 6e fa ff ff       	jmp    80105e87 <alltraps>
...
8010641b:	6a 10                	push   $0x10
  jmp alltraps
8010641d:	e9 65 fa ff ff       	jmp    80105e87 <alltraps>
...
80106422:	6a 11                	push   $0x11
  jmp alltraps
80106424:	e9 5e fa ff ff       	jmp    80105e87 <alltraps>
...
8010642b:	6a 12                	push   $0x12
  jmp alltraps
8010642d:	e9 55 fa ff ff       	jmp    80105e87 <alltraps>
...
8010643d:	6a 14                	push   $0x14
  jmp alltraps
8010643f:	e9 43 fa ff ff       	jmp    80105e87 <alltraps>
...
80106446:	6a 15                	push   $0x15
  jmp alltraps
80106448:	e9 3a fa ff ff       	jmp    80105e87 <alltraps>
...
8010644f:	6a 16                	push   $0x16
  jmp alltraps
80106451:	e9 31 fa ff ff       	jmp    80105e87 <alltraps>
...
80106458:	6a 17                	push   $0x17
  jmp alltraps
8010645a:	e9 28 fa ff ff       	jmp    80105e87 <alltraps>
...
80106461:	6a 18                	push   $0x18
  jmp alltraps
80106463:	e9 1f fa ff ff       	jmp    80105e87 <alltraps>
...
8010646a:	6a 19                	push   $0x19
  jmp alltraps
8010646c:	e9 16 fa ff ff       	jmp    80105e87 <alltraps>
...
80106473:	6a 1a                	push   $0x1a
  jmp alltraps
80106475:	e9 0d fa ff ff       	jmp    80105e87 <alltraps>
...
8010647c:	6a 1b                	push   $0x1b
  jmp alltraps
8010647e:	e9 04 fa ff ff       	jmp    80105e87 <alltraps>
...
80106485:	6a 1c                	push   $0x1c
  jmp alltraps
80106487:	e9 fb f9 ff ff       	jmp    80105e87 <alltraps>
...
8010648e:	6a 1d                	push   $0x1d
  jmp alltraps
80106490:	e9 f2 f9 ff ff       	jmp    80105e87 <alltraps>
...
80106497:	6a 1e                	push   $0x1e
  jmp alltraps
80106499:	e9 e9 f9 ff ff       	jmp    80105e87 <alltraps>
...
801064a0:	6a 1f                	push   $0x1f
  jmp alltraps
801064a2:	e9 e0 f9 ff ff       	jmp    80105e87 <alltraps>
...
801064a9:	6a 20                	push   $0x20
  jmp alltraps
801064ab:	e9 d7 f9 ff ff       	jmp    80105e87 <alltraps>
...
801064b2:	6a 21                	push   $0x21
  jmp alltraps
801064b4:	e9 ce f9 ff ff       	jmp    80105e87 <alltraps>
...
801064bb:	6a 22                	push   $0x22
  jmp alltraps
801064bd:	e9 c5 f9 ff ff       	jmp    80105e87 <alltraps>
...
801064c4:	6a 23                	push   $0x23
  jmp alltraps
801064c6:	e9 bc f9 ff ff       	jmp    80105e87 <alltraps>
...
801064cd:	6a 24                	push   $0x24
  jmp alltraps
801064cf:	e9 b3 f9 ff ff       	jmp    80105e87 <alltraps>
...
801064d6:	6a 25                	push   $0x25
  jmp alltraps
801064d8:	e9 aa f9 ff ff       	jmp    80105e87 <alltraps>
...
801064df:	6a 26                	push   $0x26
  jmp alltraps
801064e1:	e9 a1 f9 ff ff       	jmp    80105e87 <alltraps>
...
801064e8:	6a 27                	push   $0x27
  jmp alltraps
801064ea:	e9 98 f9 ff ff       	jmp    80105e87 <alltraps>
...
801064f1:	6a 28                	push   $0x28
  jmp alltraps
801064f3:	e9 8f f9 ff ff       	jmp    80105e87 <alltraps>
...
801064fa:	6a 29                	push   $0x29
  jmp alltraps
801064fc:	e9 86 f9 ff ff       	jmp    80105e87 <alltraps>
...
80106503:	6a 2a                	push   $0x2a
  jmp alltraps
80106505:	e9 7d f9 ff ff       	jmp    80105e87 <alltraps>
...
8010650c:	6a 2b                	push   $0x2b
  jmp alltraps
8010650e:	e9 74 f9 ff ff       	jmp    80105e87 <alltraps>
...
80106515:	6a 2c                	push   $0x2c
  jmp alltraps
80106517:	e9 6b f9 ff ff       	jmp    80105e87 <alltraps>
...
8010651e:	6a 2d                	push   $0x2d
  jmp alltraps
80106520:	e9 62 f9 ff ff       	jmp    80105e87 <alltraps>
...
80106527:	6a 2e                	push   $0x2e
  jmp alltraps
80106529:	e9 59 f9 ff ff       	jmp    80105e87 <alltraps>
...
80106530:	6a 2f                	push   $0x2f
  jmp alltraps
80106532:	e9 50 f9 ff ff       	jmp    80105e87 <alltraps>
...
80106539:	6a 30                	push   $0x30
  jmp alltraps
8010653b:	e9 47 f9 ff ff       	jmp    80105e87 <alltraps>
...
80106542:	6a 31                	push   $0x31
  jmp alltraps
80106544:	e9 3e f9 ff ff       	jmp    80105e87 <alltraps>
...
8010654b:	6a 32                	push   $0x32
  jmp alltraps
8010654d:	e9 35 f9 ff ff       	jmp    80105e87 <alltraps>
...
80106554:	6a 33                	push   $0x33
  jmp alltraps
80106556:	e9 2c f9 ff ff       	jmp    80105e87 <alltraps>
...
8010655d:	6a 34                	push   $0x34
  jmp alltraps
8010655f:	e9 23 f9 ff ff       	jmp    80105e87 <alltraps>
...
80106566:	6a 35                	push   $0x35
  jmp alltraps
80106568:	e9 1a f9 ff ff       	jmp    80105e87 <alltraps>
...
8010656f:	6a 36                	push   $0x36
  jmp alltraps
80106571:	e9 11 f9 ff ff       	jmp    80105e87 <alltraps>
...
80106578:	6a 37                	push   $0x37
  jmp alltraps
8010657a:	e9 08 f9 ff ff       	jmp    80105e87 <alltraps>
...
80106581:	6a 38                	push   $0x38
  jmp alltraps
80106583:	e9 ff f8 ff ff       	jmp    80105e87 <alltraps>
...
8010658a:	6a 39                	push   $0x39
  jmp alltraps
8010658c:	e9 f6 f8 ff ff       	jmp    80105e87 <alltraps>
...
80106593:	6a 3a                	push   $0x3a
  jmp alltraps
80106595:	e9 ed f8 ff ff       	jmp    80105e87 <alltraps>
...
8010659c:	6a 3b                	push   $0x3b
  jmp alltraps
8010659e:	e9 e4 f8 ff ff       	jmp    80105e87 <alltraps>
...
801065a5:	6a 3c                	push   $0x3c
  jmp alltraps
801065a7:	e9 db f8 ff ff       	jmp    80105e87 <alltraps>
...
801065ae:	6a 3d                	push   $0x3d
  jmp alltraps
801065b0:	e9 d2 f8 ff ff       	jmp    80105e87 <alltraps>
...
801065b7:	6a 3e                	push   $0x3e
  jmp alltraps
801065b9:	e9 c9 f8 ff ff       	jmp    80105e87 <alltraps>
...
801065c0:	6a 3f                	push   $0x3f
  jmp alltraps
801065c2:	e9 c0 f8 ff ff       	jmp    80105e87 <alltraps>
...
801065c9:	6a 40                	push   $0x40
  jmp alltraps
801065cb:	e9 b7 f8 ff ff       	jmp    80105e87 <alltraps>
...
801065d2:	6a 41                	push   $0x41
  jmp alltraps
801065d4:	e9 ae f8 ff ff       	jmp    80105e87 <alltraps>
...
801065db:	6a 42                	push   $0x42
  jmp alltraps
801065dd:	e9 a5 f8 ff ff       	jmp    80105e87 <alltraps>
...
801065e4:	6a 43                	push   $0x43
  jmp alltraps
801065e6:	e9 9c f8 ff ff       	jmp    80105e87 <alltraps>
...
801065ed:	6a 44                	push   $0x44
  jmp alltraps
801065ef:	e9 93 f8 ff ff       	jmp    80105e87 <alltraps>
...
801065f6:	6a 45                	push   $0x45
  jmp alltraps
801065f8:	e9 8a f8 ff ff       	jmp    80105e87 <alltraps>
...
801065ff:	6a 46                	push   $0x46
  jmp alltraps
80106601:	e9 81 f8 ff ff       	jmp    80105e87 <alltraps>
...
80106608:	6a 47                	push   $0x47
  jmp alltraps
8010660a:	e9 78 f8 ff ff       	jmp    80105e87 <alltraps>
...
80106611:	6a 48                	push   $0x48
  jmp alltraps
80106613:	e9 6f f8 ff ff       	jmp    80105e87 <alltraps>
...
8010661a:	6a 49                	push   $0x49
  jmp alltraps
8010661c:	e9 66 f8 ff ff       	jmp    80105e87 <alltraps>
...
80106623:	6a 4a                	push   $0x4a
  jmp alltraps
80106625:	e9 5d f8 ff ff       	jmp    80105e87 <alltraps>
...
8010662c:	6a 4b                	push   $0x4b
  jmp alltraps
8010662e:	e9 54 f8 ff ff       	jmp    80105e87 <alltraps>
...
80106635:	6a 4c                	push   $0x4c
  jmp alltraps
80106637:	e9 4b f8 ff ff       	jmp    80105e87 <alltraps>
...
8010663e:	6a 4d                	push   $0x4d
  jmp alltraps
80106640:	e9 42 f8 ff ff       	jmp    80105e87 <alltraps>
...
80106647:	6a 4e                	push   $0x4e
  jmp alltraps
80106649:	e9 39 f8 ff ff       	jmp    80105e87 <alltraps>
...
80106650:	6a 4f                	push   $0x4f
  jmp alltraps
80106652:	e9 30 f8 ff ff       	jmp    80105e87 <alltraps>
...
80106659:	6a 50                	push   $0x50
  jmp alltraps
8010665b:	e9 27 f8 ff ff       	jmp    80105e87 <alltraps>
...
80106662:	6a 51                	push   $0x51
  jmp alltraps
80106664:	e9 1e f8 ff ff       	jmp    80105e87 <alltraps>
...
8010666b:	6a 52                	push   $0x52
  jmp alltraps
8010666d:	e9 15 f8 ff ff       	jmp    80105e87 <alltraps>
...
80106674:	6a 53                	push   $0x53
  jmp alltraps
80106676:	e9 0c f8 ff ff       	jmp    80105e87 <alltraps>
...
8010667d:	6a 54                	push   $0x54
  jmp alltraps
8010667f:	e9 03 f8 ff ff       	jmp    80105e87 <alltraps>
...
80106686:	6a 55                	push   $0x55
  jmp alltraps
80106688:	e9 fa f7 ff ff       	jmp    80105e87 <alltraps>
...
8010668f:	6a 56                	push   $0x56
  jmp alltraps
80106691:	e9 f1 f7 ff ff       	jmp    80105e87 <alltraps>
...
80106698:	6a 57                	push   $0x57
  jmp alltraps
8010669a:	e9 e8 f7 ff ff       	jmp    80105e87 <alltraps>
...
801066a1:	6a 58                	push   $0x58
  jmp alltraps
801066a3:	e9 df f7 ff ff       	jmp    80105e87 <alltraps>
...
801066aa:	6a 59                	push   $0x59
  jmp alltraps
801066ac:	e9 d6 f7 ff ff       	jmp    80105e87 <alltraps>
...
801066b3:	6a 5a                	push   $0x5a
  jmp alltraps
801066b5:	e9 cd f7 ff ff       	jmp    80105e87 <alltraps>
...
801066bc:	6a 5b                	push   $0x5b
  jmp alltraps
801066be:	e9 c4 f7 ff ff       	jmp    80105e87 <alltraps>
...
801066c5:	6a 5c                	push   $0x5c
  jmp alltraps
801066c7:	e9 bb f7 ff ff       	jmp    80105e87 <alltraps>
...
801066ce:	6a 5d                	push   $0x5d
  jmp alltraps
801066d0:	e9 b2 f7 ff ff       	jmp    80105e87 <alltraps>
...
801066d7:	6a 5e                	push   $0x5e
  jmp alltraps
801066d9:	e9 a9 f7 ff ff       	jmp    80105e87 <alltraps>
...
801066e0:	6a 5f                	push   $0x5f
  jmp alltraps
801066e2:	e9 a0 f7 ff ff       	jmp    80105e87 <alltraps>
...
801066e9:	6a 60                	push   $0x60
  jmp alltraps
801066eb:	e9 97 f7 ff ff       	jmp    80105e87 <alltraps>
...
801066f2:	6a 61                	push   $0x61
  jmp alltraps
801066f4:	e9 8e f7 ff ff       	jmp    80105e87 <alltraps>
...
801066fb:	6a 62                	push   $0x62
  jmp alltraps
801066fd:	e9 85 f7 ff ff       	jmp    80105e87 <alltraps>
...
80106704:	6a 63                	push   $0x63
  jmp alltraps
80106706:	e9 7c f7 ff ff       	jmp    80105e87 <alltraps>
...
8010670d:	6a 64                	push   $0x64
  jmp alltraps
8010670f:	e9 73 f7 ff ff       	jmp    80105e87 <alltraps>
...
80106716:	6a 65                	push   $0x65
  jmp alltraps
80106718:	e9 6a f7 ff ff       	jmp    80105e87 <alltraps>
...
8010671f:	6a 66                	push   $0x66
  jmp alltraps
80106721:	e9 61 f7 ff ff       	jmp    80105e87 <alltraps>
...
80106728:	6a 67                	push   $0x67
  jmp alltraps
8010672a:	e9 58 f7 ff ff       	jmp    80105e87 <alltraps>
...
80106731:	6a 68                	push   $0x68
  jmp alltraps
80106733:	e9 4f f7 ff ff       	jmp    80105e87 <alltraps>
...
8010673a:	6a 69                	push   $0x69
  jmp alltraps
8010673c:	e9 46 f7 ff ff       	jmp    80105e87 <alltraps>
...
80106743:	6a 6a                	push   $0x6a
  jmp alltraps
80106745:	e9 3d f7 ff ff       	jmp    80105e87 <alltraps>
...
8010674c:	6a 6b                	push   $0x6b
  jmp alltraps
8010674e:	e9 34 f7 ff ff       	jmp    80105e87 <alltraps>
...
80106755:	6a 6c                	push   $0x6c
  jmp alltraps
80106757:	e9 2b f7 ff ff       	jmp    80105e87 <alltraps>
...
8010675e:	6a 6d                	push   $0x6d
  jmp alltraps
80106760:	e9 22 f7 ff ff       	jmp    80105e87 <alltraps>
...
80106767:	6a 6e                	push   $0x6e
  jmp alltraps
80106769:	e9 19 f7 ff ff       	jmp    80105e87 <alltraps>
...
80106770:	6a 6f                	push   $0x6f
  jmp alltraps
80106772:	e9 10 f7 ff ff       	jmp    80105e87 <alltraps>
...
80106779:	6a 70                	push   $0x70
  jmp alltraps
8010677b:	e9 07 f7 ff ff       	jmp    80105e87 <alltraps>
...
80106782:	6a 71                	push   $0x71
  jmp alltraps
80106784:	e9 fe f6 ff ff       	jmp    80105e87 <alltraps>
...
8010678b:	6a 72                	push   $0x72
  jmp alltraps
8010678d:	e9 f5 f6 ff ff       	jmp    80105e87 <alltraps>
...
80106794:	6a 73                	push   $0x73
  jmp alltraps
80106796:	e9 ec f6 ff ff       	jmp    80105e87 <alltraps>
...
8010679d:	6a 74                	push   $0x74
  jmp alltraps
8010679f:	e9 e3 f6 ff ff       	jmp    80105e87 <alltraps>
...
801067a6:	6a 75                	push   $0x75
  jmp alltraps
801067a8:	e9 da f6 ff ff       	jmp    80105e87 <alltraps>
...
801067af:	6a 76                	push   $0x76
  jmp alltraps
801067b1:	e9 d1 f6 ff ff       	jmp    80105e87 <alltraps>
...
801067b8:	6a 77                	push   $0x77
  jmp alltraps
801067ba:	e9 c8 f6 ff ff       	jmp    80105e87 <alltraps>
...
801067c1:	6a 78                	push   $0x78
  jmp alltraps
801067c3:	e9 bf f6 ff ff       	jmp    80105e87 <alltraps>
...
801067ca:	6a 79                	push   $0x79
  jmp alltraps
801067cc:	e9 b6 f6 ff ff       	jmp    80105e87 <alltraps>
...
801067d3:	6a 7a                	push   $0x7a
  jmp alltraps
801067d5:	e9 ad f6 ff ff       	jmp    80105e87 <alltraps>
...
801067dc:	6a 7b                	push   $0x7b
  jmp alltraps
801067de:	e9 a4 f6 ff ff       	jmp    80105e87 <alltraps>
...
801067e5:	6a 7c                	push   $0x7c
  jmp alltraps
801067e7:	e9 9b f6 ff ff       	jmp    80105e87 <alltraps>
...
801067ee:	6a 7d                	push   $0x7d
  jmp alltraps
801067f0:	e9 92 f6 ff ff       	jmp    80105e87 <alltraps>
...
801067f7:	6a 7e                	push   $0x7e
  jmp alltraps
801067f9:	e9 89 f6 ff ff       	jmp    80105e87 <alltraps>
...
80106800:	6a 7f                	push   $0x7f
  jmp alltraps
80106802:	e9 80 f6 ff ff       	jmp    80105e87 <alltraps>
...
80106809:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010680e:	e9 74 f6 ff ff       	jmp    80105e87 <alltraps>
...
80106815:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010681a:	e9 68 f6 ff ff       	jmp    80105e87 <alltraps>
...
80106821:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106826:	e9 5c f6 ff ff       	jmp    80105e87 <alltraps>
...
8010682d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106832:	e9 50 f6 ff ff       	jmp    80105e87 <alltraps>
...
80106839:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010683e:	e9 44 f6 ff ff       	jmp    80105e87 <alltraps>
...
80106845:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010684a:	e9 38 f6 ff ff       	jmp    80105e87 <alltraps>
...
80106851:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106856:	e9 2c f6 ff ff       	jmp    80105e87 <alltraps>
...
8010685d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106862:	e9 20 f6 ff ff       	jmp    80105e87 <alltraps>
...
80106869:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010686e:	e9 14 f6 ff ff       	jmp    80105e87 <alltraps>
...
80106875:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010687a:	e9 08 f6 ff ff       	jmp    80105e87 <alltraps>
...
80106881:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106886:	e9 fc f5 ff ff       	jmp    80105e87 <alltraps>
...
8010688d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106892:	e9 f0 f5 ff ff       	jmp    80105e87 <alltraps>
...
80106899:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010689e:	e9 e4 f5 ff ff       	jmp    80105e87 <alltraps>
...
801068a5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801068aa:	e9 d8 f5 ff ff       	jmp    80105e87 <alltraps>
...
801068b1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801068b6:	e9 cc f5 ff ff       	jmp    80105e87 <alltraps>
...
801068bd:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801068c2:	e9 c0 f5 ff ff       	jmp    80105e87 <alltraps>
...
801068c9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801068ce:	e9 b4 f5 ff ff       	jmp    80105e87 <alltraps>
...
801068d5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801068da:	e9 a8 f5 ff ff       	jmp    80105e87 <alltraps>
...
801068e1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801068e6:	e9 9c f5 ff ff       	jmp    80105e87 <alltraps>
...
801068ed:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801068f2:	e9 90 f5 ff ff       	jmp    80105e87 <alltraps>
...
801068f9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801068fe:	e9 84 f5 ff ff       	jmp    80105e87 <alltraps>
...
80106905:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010690a:	e9 78 f5 ff ff       	jmp    80105e87 <alltraps>
...
80106911:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106916:	e9 6c f5 ff ff       	jmp    80105e87 <alltraps>
...
8010691d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106922:	e9 60 f5 ff ff       	jmp    80105e87 <alltraps>
...
80106929:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010692e:	e9 54 f5 ff ff       	jmp    80105e87 <alltraps>
...
80106935:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010693a:	e9 48 f5 ff ff       	jmp    80105e87 <alltraps>
...
80106941:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106946:	e9 3c f5 ff ff       	jmp    80105e87 <alltraps>
...
8010694d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106952:	e9 30 f5 ff ff       	jmp    80105e87 <alltraps>
...
80106959:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010695e:	e9 24 f5 ff ff       	jmp    80105e87 <alltraps>
...
80106965:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010696a:	e9 18 f5 ff ff       	jmp    80105e87 <alltraps>
...
80106971:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106976:	e9 0c f5 ff ff       	jmp    80105e87 <alltraps>
...
8010697d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106982:	e9 00 f5 ff ff       	jmp    80105e87 <alltraps>
...
80106989:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010698e:	e9 f4 f4 ff ff       	jmp    80105e87 <alltraps>
...
80106995:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010699a:	e9 e8 f4 ff ff       	jmp    80105e87 <alltraps>
...
801069a1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801069a6:	e9 dc f4 ff ff       	jmp    80105e87 <alltraps>
...
801069ad:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801069b2:	e9 d0 f4 ff ff       	jmp    80105e87 <alltraps>
...
801069b9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801069be:	e9 c4 f4 ff ff       	jmp    80105e87 <alltraps>
...
801069c5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801069ca:	e9 b8 f4 ff ff       	jmp    80105e87 <alltraps>
...
801069d1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801069d6:	e9 ac f4 ff ff       	jmp    80105e87 <alltraps>
...
801069dd:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801069e2:	e9 a0 f4 ff ff       	jmp    80105e87 <alltraps>
...
801069e9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801069ee:	e9 94 f4 ff ff       	jmp    80105e87 <alltraps>
...
801069f5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801069fa:	e9 88 f4 ff ff       	jmp    80105e87 <alltraps>
...
80106a01:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106a06:	e9 7c f4 ff ff       	jmp    80105e87 <alltraps>
...
80106a0d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106a12:	e9 70 f4 ff ff       	jmp    80105e87 <alltraps>
...
80106a19:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80106a1e:	e9 64 f4 ff ff       	jmp    80105e87 <alltraps>
...
80106a25:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80106a2a:	e9 58 f4 ff ff       	jmp    80105e87 <alltraps>
...
80106a31:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106a36:	e9 4c f4 ff ff       	jmp    80105e87 <alltraps>
...
80106a3d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106a42:	e9 40 f4 ff ff       	jmp    80105e87 <alltraps>
...
80106a49:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80106a4e:	e9 34 f4 ff ff       	jmp    80105e87 <alltraps>
...
80106a55:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80106a5a:	e9 28 f4 ff ff       	jmp    80105e87 <alltraps>
...
80106a61:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106a66:	e9 1c f4 ff ff       	jmp    80105e87 <alltraps>
...
80106a6d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106a72:	e9 10 f4 ff ff       	jmp    80105e87 <alltraps>
...
80106a79:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80106a7e:	e9 04 f4 ff ff       	jmp    80105e87 <alltraps>
...
80106a85:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80106a8a:	e9 f8 f3 ff ff       	jmp    80105e87 <alltraps>
...
80106a91:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106a96:	e9 ec f3 ff ff       	jmp    80105e87 <alltraps>
...
80106a9d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106aa2:	e9 e0 f3 ff ff       	jmp    80105e87 <alltraps>
...
80106aa9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80106aae:	e9 d4 f3 ff ff       	jmp    80105e87 <alltraps>
...
80106ab5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80106aba:	e9 c8 f3 ff ff       	jmp    80105e87 <alltraps>
...
80106ac1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106ac6:	e9 bc f3 ff ff       	jmp    80105e87 <alltraps>
...
80106acd:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106ad2:	e9 b0 f3 ff ff       	jmp    80105e87 <alltraps>
...
80106ad9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80106ade:	e9 a4 f3 ff ff       	jmp    80105e87 <alltraps>
...
80106ae5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80106aea:	e9 98 f3 ff ff       	jmp    80105e87 <alltraps>
...
80106af1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106af6:	e9 8c f3 ff ff       	jmp    80105e87 <alltraps>
...
80106afd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106b02:	e9 80 f3 ff ff       	jmp    80105e87 <alltraps>
...
80106b09:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80106b0e:	e9 74 f3 ff ff       	jmp    80105e87 <alltraps>
...
80106b15:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80106b1a:	e9 68 f3 ff ff       	jmp    80105e87 <alltraps>
...
80106b21:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106b26:	e9 5c f3 ff ff       	jmp    80105e87 <alltraps>
...
80106b2d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106b32:	e9 50 f3 ff ff       	jmp    80105e87 <alltraps>
...
80106b39:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80106b3e:	e9 44 f3 ff ff       	jmp    80105e87 <alltraps>
...
80106b45:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106b4a:	e9 38 f3 ff ff       	jmp    80105e87 <alltraps>
...
80106b51:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106b56:	e9 2c f3 ff ff       	jmp    80105e87 <alltraps>
...
80106b5d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106b62:	e9 20 f3 ff ff       	jmp    80105e87 <alltraps>
...
80106b69:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80106b6e:	e9 14 f3 ff ff       	jmp    80105e87 <alltraps>
...
80106b75:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106b7a:	e9 08 f3 ff ff       	jmp    80105e87 <alltraps>
...
80106b81:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106b86:	e9 fc f2 ff ff       	jmp    80105e87 <alltraps>
...
80106b8d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106b92:	e9 f0 f2 ff ff       	jmp    80105e87 <alltraps>
...
80106b99:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80106b9e:	e9 e4 f2 ff ff       	jmp    80105e87 <alltraps>
...
80106ba5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80106baa:	e9 d8 f2 ff ff       	jmp    80105e87 <alltraps>
...
80106bb1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106bb6:	e9 cc f2 ff ff       	jmp    80105e87 <alltraps>
...
80106bbd:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106bc2:	e9 c0 f2 ff ff       	jmp    80105e87 <alltraps>
...
80106bc9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80106bce:	e9 b4 f2 ff ff       	jmp    80105e87 <alltraps>
...
80106bd5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80106bda:	e9 a8 f2 ff ff       	jmp    80105e87 <alltraps>
...
80106be1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106be6:	e9 9c f2 ff ff       	jmp    80105e87 <alltraps>
...
80106bed:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106bf2:	e9 90 f2 ff ff       	jmp    80105e87 <alltraps>
...
80106bf9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80106bfe:	e9 84 f2 ff ff       	jmp    80105e87 <alltraps>
...
80106c05:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106c0a:	e9 78 f2 ff ff       	jmp    80105e87 <alltraps>
...
80106c11:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106c16:	e9 6c f2 ff ff       	jmp    80105e87 <alltraps>
...
80106c1d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106c22:	e9 60 f2 ff ff       	jmp    80105e87 <alltraps>
...
80106c29:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106c2e:	e9 54 f2 ff ff       	jmp    80105e87 <alltraps>
...
80106c35:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106c3a:	e9 48 f2 ff ff       	jmp    80105e87 <alltraps>
...
80106c41:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106c46:	e9 3c f2 ff ff       	jmp    80105e87 <alltraps>
...
80106c4d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106c52:	e9 30 f2 ff ff       	jmp    80105e87 <alltraps>
...
80106c59:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106c5e:	e9 24 f2 ff ff       	jmp    80105e87 <alltraps>
...
80106c65:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106c6a:	e9 18 f2 ff ff       	jmp    80105e87 <alltraps>
...
80106c71:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106c76:	e9 0c f2 ff ff       	jmp    80105e87 <alltraps>
...
80106c7d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106c82:	e9 00 f2 ff ff       	jmp    80105e87 <alltraps>
...
80106c89:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80106c8e:	e9 f4 f1 ff ff       	jmp    80105e87 <alltraps>
...
80106c95:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106c9a:	e9 e8 f1 ff ff       	jmp    80105e87 <alltraps>
...
80106ca1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106ca6:	e9 dc f1 ff ff       	jmp    80105e87 <alltraps>
...
80106cad:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106cb2:	e9 d0 f1 ff ff       	jmp    80105e87 <alltraps>
...
80106cb9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80106cbe:	e9 c4 f1 ff ff       	jmp    80105e87 <alltraps>
...
80106cc5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106cca:	e9 b8 f1 ff ff       	jmp    80105e87 <alltraps>
...
80106cd1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106cd6:	e9 ac f1 ff ff       	jmp    80105e87 <alltraps>
...
80106cdd:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106ce2:	e9 a0 f1 ff ff       	jmp    80105e87 <alltraps>
...
80106ce9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106cee:	e9 94 f1 ff ff       	jmp    80105e87 <alltraps>
...
80106cf5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106cfa:	e9 88 f1 ff ff       	jmp    80105e87 <alltraps>
...
80106d01:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106d06:	e9 7c f1 ff ff       	jmp    80105e87 <alltraps>
...
80106d0d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106d12:	e9 70 f1 ff ff       	jmp    80105e87 <alltraps>
...
80106d19:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106d1e:	e9 64 f1 ff ff       	jmp    80105e87 <alltraps>
...
80106d25:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106d2a:	e9 58 f1 ff ff       	jmp    80105e87 <alltraps>
...
80106d31:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106d36:	e9 4c f1 ff ff       	jmp    80105e87 <alltraps>
...
80106d3d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106d42:	e9 40 f1 ff ff       	jmp    80105e87 <alltraps>
...
80106d49:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106d4e:	e9 34 f1 ff ff       	jmp    80105e87 <alltraps>
...
80106d55:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106d5a:	e9 28 f1 ff ff       	jmp    80105e87 <alltraps>
...
80106d61:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106d66:	e9 1c f1 ff ff       	jmp    80105e87 <alltraps>
...
80106d6d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106d72:	e9 10 f1 ff ff       	jmp    80105e87 <alltraps>
...
80106d79:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106d7e:	e9 04 f1 ff ff       	jmp    80105e87 <alltraps>
...
80106d85:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106d8a:	e9 f8 f0 ff ff       	jmp    80105e87 <alltraps>
...
80106d91:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106d96:	e9 ec f0 ff ff       	jmp    80105e87 <alltraps>
...
80106d9d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106da2:	e9 e0 f0 ff ff       	jmp    80105e87 <alltraps>
...
80106da9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106dae:	e9 d4 f0 ff ff       	jmp    80105e87 <alltraps>
...
80106db5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106dba:	e9 c8 f0 ff ff       	jmp    80105e87 <alltraps>
...
80106dc1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106dc6:	e9 bc f0 ff ff       	jmp    80105e87 <alltraps>
...
80106dcd:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106dd2:	e9 b0 f0 ff ff       	jmp    80105e87 <alltraps>
...
80106dd9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106dde:	e9 a4 f0 ff ff       	jmp    80105e87 <alltraps>
...
80106de5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106dea:	e9 98 f0 ff ff       	jmp    80105e87 <alltraps>
...
80106df1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106df6:	e9 8c f0 ff ff       	jmp    80105e87 <alltraps>
...
80106dfd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106e02:	e9 80 f0 ff ff       	jmp    80105e87 <alltraps>
...
80106e1c:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
80106e22:	83 ec 1c             	sub    $0x1c,%esp
  for(; a  < oldsz; a += PGSIZE){
80106e25:	39 d3                	cmp    %edx,%ebx
80106e27:	73 56                	jae    80106e7f <deallocuvm.part.0+0x6f>
80106e29:	89 4d e0             	mov    %ecx,-0x20(%ebp)
80106e2c:	89 c6                	mov    %eax,%esi
80106e2e:	89 d7                	mov    %edx,%edi
80106e30:	eb 12                	jmp    80106e44 <deallocuvm.part.0+0x34>
80106e32:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
80106e38:	83 c2 01             	add    $0x1,%edx
80106e3b:	89 d3                	mov    %edx,%ebx
80106e3d:	c1 e3 16             	shl    $0x16,%ebx
  for(; a  < oldsz; a += PGSIZE){
80106e40:	39 fb                	cmp    %edi,%ebx
80106e42:	73 38                	jae    80106e7c <deallocuvm.part.0+0x6c>
  pde = &pgdir[PDX(va)];
80106e44:	89 da                	mov    %ebx,%edx
80106e46:	c1 ea 16             	shr    $0x16,%edx
  if(*pde & PTE_P){
80106e49:	8b 04 96             	mov    (%esi,%edx,4),%eax
80106e4c:	a8 01                	test   $0x1,%al
80106e4e:	74 e8                	je     80106e38 <deallocuvm.part.0+0x28>
  return &pgtab[PTX(va)];
80106e50:	89 d9                	mov    %ebx,%ecx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106e52:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  return &pgtab[PTX(va)];
80106e57:	c1 e9 0a             	shr    $0xa,%ecx
80106e5a:	81 e1 fc 0f 00 00    	and    $0xffc,%ecx
80106e60:	8d 84 08 00 00 00 80 	lea    -0x80000000(%eax,%ecx,1),%eax
    if(!pte)
80106e67:	85 c0                	test   %eax,%eax
80106e69:	74 cd                	je     80106e38 <deallocuvm.part.0+0x28>
    else if((*pte & PTE_P) != 0){
80106e6b:	8b 10                	mov    (%eax),%edx
80106e6d:	f6 c2 01             	test   $0x1,%dl
80106e70:	75 1e                	jne    80106e90 <deallocuvm.part.0+0x80>
  for(; a  < oldsz; a += PGSIZE){
80106e72:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106e78:	39 fb                	cmp    %edi,%ebx
80106e7a:	72 c8                	jb     80106e44 <deallocuvm.part.0+0x34>
80106e7c:	8b 4d e0             	mov    -0x20(%ebp),%ecx
      kfree(v);
      *pte = 0;
    }
  }
...
80106e89:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      if(pa == 0)
80106e90:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
80106e96:	74 26                	je     80106ebe <deallocuvm.part.0+0xae>
      kfree(v);
80106e98:	83 ec 0c             	sub    $0xc,%esp
      char *v = P2V(pa);
80106e9b:	81 c2 00 00 00 80    	add    $0x80000000,%edx
80106ea1:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80106ea4:	81 c3 00 10 00 00    	add    $0x1000,%ebx
      kfree(v);
80106eaa:	52                   	push   %edx
80106eab:	e8 f0 b5 ff ff       	call   801024a0 <kfree>
      *pte = 0;
80106eb0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  for(; a  < oldsz; a += PGSIZE){
80106eb3:	83 c4 10             	add    $0x10,%esp
      *pte = 0;
80106eb6:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
80106ebc:	eb 82                	jmp    80106e40 <deallocuvm.part.0+0x30>
        panic("kfree");
80106ebe:	83 ec 0c             	sub    $0xc,%esp
80106ec1:	68 a6 79 10 80       	push   $0x801079a6
80106ec6:	e8 b5 94 ff ff       	call   80100380 <panic>
...
80106ee1:	89 45 e0             	mov    %eax,-0x20(%ebp)
...
80106ef8:	eb 3f                	jmp    80106f39 <mappages+0x69>
...
80106f2a:	89 30                	mov    %esi,(%eax)
    if(a == last)
80106f2c:	8b 45 dc             	mov    -0x24(%ebp),%eax
80106f2f:	39 c3                	cmp    %eax,%ebx
80106f31:	74 6d                	je     80106fa0 <mappages+0xd0>
    a += PGSIZE;
80106f33:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  for(;;){
80106f39:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  pde = &pgdir[PDX(va)];
80106f3c:	8b 4d e0             	mov    -0x20(%ebp),%ecx
80106f3f:	8d 34 03             	lea    (%ebx,%eax,1),%esi
80106f42:	89 d8                	mov    %ebx,%eax
80106f44:	c1 e8 16             	shr    $0x16,%eax
80106f47:	8d 3c 81             	lea    (%ecx,%eax,4),%edi
  if(*pde & PTE_P){
80106f4a:	8b 07                	mov    (%edi),%eax
80106f4c:	a8 01                	test   $0x1,%al
80106f4e:	75 b0                	jne    80106f00 <mappages+0x30>
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80106f50:	e8 0b b7 ff ff       	call   80102660 <kalloc>
80106f55:	85 c0                	test   %eax,%eax
80106f57:	74 37                	je     80106f90 <mappages+0xc0>
    memset(pgtab, 0, PGSIZE);
80106f59:	83 ec 04             	sub    $0x4,%esp
80106f5c:	68 00 10 00 00       	push   $0x1000
80106f61:	6a 00                	push   $0x0
80106f63:	50                   	push   %eax
80106f64:	89 45 d8             	mov    %eax,-0x28(%ebp)
80106f67:	e8 74 dc ff ff       	call   80104be0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80106f6c:	8b 55 d8             	mov    -0x28(%ebp),%edx
  return &pgtab[PTX(va)];
80106f6f:	83 c4 10             	add    $0x10,%esp
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80106f72:	8d 82 00 00 00 80    	lea    -0x80000000(%edx),%eax
80106f78:	83 c8 07             	or     $0x7,%eax
80106f7b:	89 07                	mov    %eax,(%edi)
  return &pgtab[PTX(va)];
80106f7d:	89 d8                	mov    %ebx,%eax
80106f7f:	c1 e8 0a             	shr    $0xa,%eax
80106f82:	25 fc 0f 00 00       	and    $0xffc,%eax
80106f87:	01 d0                	add    %edx,%eax
80106f89:	eb 90                	jmp    80106f1b <mappages+0x4b>
80106f8b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
}
...
80106fad:	68 e1 7b 10 80       	push   $0x80107be1
...
80106fc3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106fc6:	e8 a5 c9 ff ff       	call   80103970 <cpuid>
  pd[0] = size-1;
...
80106fda:	c7 80 18 28 11 80 ff 	movl   $0xffff,-0x7feed7e8(%eax)
80106fe1:	ff 00 00 
80106fe4:	c7 80 1c 28 11 80 00 	movl   $0xcf9a00,-0x7feed7e4(%eax)
80106feb:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106fee:	c7 80 20 28 11 80 ff 	movl   $0xffff,-0x7feed7e0(%eax)
80106ff5:	ff 00 00 
80106ff8:	c7 80 24 28 11 80 00 	movl   $0xcf9200,-0x7feed7dc(%eax)
80106fff:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80107002:	c7 80 28 28 11 80 ff 	movl   $0xffff,-0x7feed7d8(%eax)
80107009:	ff 00 00 
8010700c:	c7 80 2c 28 11 80 00 	movl   $0xcffa00,-0x7feed7d4(%eax)
80107013:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80107016:	c7 80 30 28 11 80 ff 	movl   $0xffff,-0x7feed7d0(%eax)
8010701d:	ff 00 00 
80107020:	c7 80 34 28 11 80 00 	movl   $0xcff200,-0x7feed7cc(%eax)
80107027:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
8010702a:	05 10 28 11 80       	add    $0x80112810,%eax
  pd[1] = (uint)p;
...
80107040:	c9                   	leave
80107041:	c3                   	ret
80107042:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80107049:	00 
8010704a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

80107050 <switchkvm>:
  lcr3(V2P(kpgdir));   // switch to the kernel page table
80107050:	a1 84 63 11 80       	mov    0x80116384,%eax
...
8010706e:	0f 84 cb 00 00 00    	je     8010713f <switchuvm+0xdf>
  if(p->kstack == 0)
80107074:	8b 46 0c             	mov    0xc(%esi),%eax
80107077:	85 c0                	test   %eax,%eax
80107079:	0f 84 da 00 00 00    	je     80107159 <switchuvm+0xf9>
  if(p->pgdir == 0)
8010707f:	8b 46 08             	mov    0x8(%esi),%eax
80107082:	85 c0                	test   %eax,%eax
80107084:	0f 84 c2 00 00 00    	je     8010714c <switchuvm+0xec>
  pushcli();
8010708a:	e8 21 d5 ff ff       	call   801045b0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010708f:	e8 7c c8 ff ff       	call   80103910 <mycpu>
80107094:	89 c3                	mov    %eax,%ebx
80107096:	e8 75 c8 ff ff       	call   80103910 <mycpu>
8010709b:	89 c7                	mov    %eax,%edi
8010709d:	e8 6e c8 ff ff       	call   80103910 <mycpu>
801070a2:	83 c7 08             	add    $0x8,%edi
801070a5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801070a8:	e8 63 c8 ff ff       	call   80103910 <mycpu>
...
8010718b:	77 49                	ja     801071d6 <inituvm+0x66>
  mem = kalloc();
8010718d:	e8 ce b4 ff ff       	call   80102660 <kalloc>
  memset(mem, 0, PGSIZE);
...
801071b9:	e8 12 fd ff ff       	call   80106ed0 <mappages>
  memmove(mem, init, sz);
801071be:	83 c4 10             	add    $0x10,%esp
801071c1:	89 75 10             	mov    %esi,0x10(%ebp)
801071c4:	89 7d 0c             	mov    %edi,0xc(%ebp)
...
801071d0:	5d                   	pop    %ebp
  memmove(mem, init, sz);
801071d1:	e9 9a da ff ff       	jmp    80104c70 <memmove>
    panic("inituvm: more than a page");
801071d6:	83 ec 0c             	sub    $0xc,%esp
801071d9:	68 26 7c 10 80       	push   $0x80107c26
801071de:	e8 9d 91 ff ff       	call   80100380 <panic>
801071e3:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801071ea:	00 
...
801071f9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
801071fc:	8b 7d 18             	mov    0x18(%ebp),%edi
  if((uint) addr % PGSIZE != 0)
801071ff:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80107205:	0f 85 a2 00 00 00    	jne    801072ad <loaduvm+0xbd>
  for(i = 0; i < sz; i += PGSIZE){
8010720b:	85 ff                	test   %edi,%edi
8010720d:	74 7d                	je     8010728c <loaduvm+0x9c>
8010720f:	90                   	nop
  pde = &pgdir[PDX(va)];
80107210:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(*pde & PTE_P){
80107213:	8b 55 08             	mov    0x8(%ebp),%edx
80107216:	01 f0                	add    %esi,%eax
  pde = &pgdir[PDX(va)];
80107218:	89 c1                	mov    %eax,%ecx
8010721a:	c1 e9 16             	shr    $0x16,%ecx
  if(*pde & PTE_P){
8010721d:	8b 0c 8a             	mov    (%edx,%ecx,4),%ecx
80107220:	f6 c1 01             	test   $0x1,%cl
80107223:	75 13                	jne    80107238 <loaduvm+0x48>
      panic("loaduvm: address should exist");
80107225:	83 ec 0c             	sub    $0xc,%esp
80107228:	68 40 7c 10 80       	push   $0x80107c40
8010722d:	e8 4e 91 ff ff       	call   80100380 <panic>
80107232:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  return &pgtab[PTX(va)];
80107238:	c1 e8 0a             	shr    $0xa,%eax
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
8010723b:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
  return &pgtab[PTX(va)];
80107241:	25 fc 0f 00 00       	and    $0xffc,%eax
80107246:	8d 8c 01 00 00 00 80 	lea    -0x80000000(%ecx,%eax,1),%ecx
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
8010724d:	85 c9                	test   %ecx,%ecx
8010724f:	74 d4                	je     80107225 <loaduvm+0x35>
    if(sz - i < PGSIZE)
80107251:	89 fb                	mov    %edi,%ebx
80107253:	b8 00 10 00 00       	mov    $0x1000,%eax
80107258:	29 f3                	sub    %esi,%ebx
8010725a:	39 c3                	cmp    %eax,%ebx
8010725c:	0f 47 d8             	cmova  %eax,%ebx
    if(readi(ip, P2V(pa), offset+i, n) != n)
8010725f:	53                   	push   %ebx
80107260:	8b 45 14             	mov    0x14(%ebp),%eax
80107263:	01 f0                	add    %esi,%eax
80107265:	50                   	push   %eax
    pa = PTE_ADDR(*pte);
80107266:	8b 01                	mov    (%ecx),%eax
80107268:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(readi(ip, P2V(pa), offset+i, n) != n)
8010726d:	05 00 00 00 80       	add    $0x80000000,%eax
80107272:	50                   	push   %eax
80107273:	ff 75 10             	push   0x10(%ebp)
80107276:	e8 35 a8 ff ff       	call   80101ab0 <readi>
8010727b:	83 c4 10             	add    $0x10,%esp
8010727e:	39 d8                	cmp    %ebx,%eax
80107280:	75 1e                	jne    801072a0 <loaduvm+0xb0>
  for(i = 0; i < sz; i += PGSIZE){
80107282:	81 c6 00 10 00 00    	add    $0x1000,%esi
80107288:	39 fe                	cmp    %edi,%esi
8010728a:	72 84                	jb     80107210 <loaduvm+0x20>
}
8010728c:	8d 65 f4             	lea    -0xc(%ebp),%esp
  return 0;
8010728f:	31 c0                	xor    %eax,%eax
}
80107291:	5b                   	pop    %ebx
80107292:	5e                   	pop    %esi
80107293:	5f                   	pop    %edi
...
801072b0:	68 64 7e 10 80       	push   $0x80107e64
801072b5:	e8 c6 90 ff ff       	call   80100380 <panic>
...
801072ce:	0f 88 98 00 00 00    	js     8010736c <allocuvm+0xac>
801072d4:	89 f2                	mov    %esi,%edx
  if(newsz < oldsz)
801072d6:	3b 75 0c             	cmp    0xc(%ebp),%esi
801072d9:	0f 82 a1 00 00 00    	jb     80107380 <allocuvm+0xc0>
  a = PGROUNDUP(oldsz);
801072df:	8b 45 0c             	mov    0xc(%ebp),%eax
801072e2:	05 ff 0f 00 00       	add    $0xfff,%eax
801072e7:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801072ec:	89 c7                	mov    %eax,%edi
  for(; a < newsz; a += PGSIZE){
801072ee:	39 f0                	cmp    %esi,%eax
801072f0:	0f 83 8d 00 00 00    	jae    80107383 <allocuvm+0xc3>
801072f6:	89 75 e4             	mov    %esi,-0x1c(%ebp)
801072f9:	eb 44                	jmp    8010733f <allocuvm+0x7f>
...
8010731f:	89 fa                	mov    %edi,%edx
80107321:	50                   	push   %eax
80107322:	8b 45 08             	mov    0x8(%ebp),%eax
80107325:	e8 a6 fb ff ff       	call   80106ed0 <mappages>
8010732a:	83 c4 10             	add    $0x10,%esp
8010732d:	85 c0                	test   %eax,%eax
8010732f:	78 5f                	js     80107390 <allocuvm+0xd0>
  for(; a < newsz; a += PGSIZE){
80107331:	81 c7 00 10 00 00    	add    $0x1000,%edi
80107337:	39 f7                	cmp    %esi,%edi
80107339:	0f 83 89 00 00 00    	jae    801073c8 <allocuvm+0x108>
    mem = kalloc();
8010733f:	e8 1c b3 ff ff       	call   80102660 <kalloc>
80107344:	89 c3                	mov    %eax,%ebx
    if(mem == 0){
80107346:	85 c0                	test   %eax,%eax
80107348:	75 b6                	jne    80107300 <allocuvm+0x40>
      cprintf("allocuvm out of memory\n");
8010734a:	83 ec 0c             	sub    $0xc,%esp
8010734d:	68 5e 7c 10 80       	push   $0x80107c5e
80107352:	e8 59 93 ff ff       	call   801006b0 <cprintf>
  if(newsz >= oldsz)
80107357:	83 c4 10             	add    $0x10,%esp
8010735a:	3b 75 0c             	cmp    0xc(%ebp),%esi
8010735d:	74 0d                	je     8010736c <allocuvm+0xac>
8010735f:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80107362:	8b 45 08             	mov    0x8(%ebp),%eax
80107365:	89 f2                	mov    %esi,%edx
80107367:	e8 a4 fa ff ff       	call   80106e10 <deallocuvm.part.0>
    return 0;
8010736c:	31 d2                	xor    %edx,%edx
}
8010736e:	8d 65 f4             	lea    -0xc(%ebp),%esp
80107371:	89 d0                	mov    %edx,%eax
80107373:	5b                   	pop    %ebx
80107374:	5e                   	pop    %esi
80107375:	5f                   	pop    %edi
80107376:	5d                   	pop    %ebp
...
80107393:	68 76 7c 10 80       	push   $0x80107c76
80107398:	e8 13 93 ff ff       	call   801006b0 <cprintf>
  if(newsz >= oldsz)
8010739d:	83 c4 10             	add    $0x10,%esp
801073a0:	3b 75 0c             	cmp    0xc(%ebp),%esi
801073a3:	74 0d                	je     801073b2 <allocuvm+0xf2>
801073a5:	8b 4d 0c             	mov    0xc(%ebp),%ecx
801073a8:	8b 45 08             	mov    0x8(%ebp),%eax
801073ab:	89 f2                	mov    %esi,%edx
801073ad:	e8 5e fa ff ff       	call   80106e10 <deallocuvm.part.0>
      kfree(mem);
801073b2:	83 ec 0c             	sub    $0xc,%esp
801073b5:	53                   	push   %ebx
801073b6:	e8 e5 b0 ff ff       	call   801024a0 <kfree>
      return 0;
801073bb:	83 c4 10             	add    $0x10,%esp
    return 0;
801073be:	31 d2                	xor    %edx,%edx
801073c0:	eb ac                	jmp    8010736e <allocuvm+0xae>
801073c2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
801073c8:	8b 55 e4             	mov    -0x1c(%ebp),%edx
}
...
801073d3:	5d                   	pop    %ebp
801073d4:	c3                   	ret
801073d5:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801073dc:	00 
...
801073f0:	5d                   	pop    %ebp
801073f1:	e9 1a fa ff ff       	jmp    80106e10 <deallocuvm.part.0>
...
80107402:	5d                   	pop    %ebp
80107403:	c3                   	ret
80107404:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010740b:	00 
...
8010742b:	e8 e0 f9 ff ff       	call   80106e10 <deallocuvm.part.0>
...
8010745e:	e8 3d b0 ff ff       	call   801024a0 <kfree>
...
80107473:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80107474:	e9 27 b0 ff ff       	jmp    801024a0 <kfree>
    panic("freevm: no pgdir");
80107479:	83 ec 0c             	sub    $0xc,%esp
8010747c:	68 92 7c 10 80       	push   $0x80107c92
...
80107495:	e8 c6 b1 ff ff       	call   80102660 <kalloc>
...
801074cb:	e8 00 fa ff ff       	call   80106ed0 <mappages>
...
8010751b:	a3 84 63 11 80       	mov    %eax,0x80116384
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010754c:	68 a3 7c 10 80       	push   $0x80107ca3
80107551:	e8 2a 8e ff ff       	call   80100380 <panic>
80107556:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010755d:	00 
...
801075c2:	68 ad 7c 10 80       	push   $0x80107cad
801075c7:	e8 b4 8d ff ff       	call   80100380 <panic>
...
801075ff:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80107605:	e8 56 b0 ff ff       	call   80102660 <kalloc>
...
80107620:	e8 4b d6 ff ff       	call   80104c70 <memmove>
...
8010763b:	e8 90 f8 ff ff       	call   80106ed0 <mappages>
...
8010766c:	e8 2f ae ff ff       	call   801024a0 <kfree>
      goto bad;
...
80107697:	68 c7 7c 10 80       	push   $0x80107cc7
8010769c:	e8 df 8c ff ff       	call   80100380 <panic>
801076a1:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801076a8:	00 
...
801076b6:	8b 55 08             	mov    0x8(%ebp),%edx
  pde = &pgdir[PDX(va)];
801076b9:	89 c1                	mov    %eax,%ecx
801076bb:	c1 e9 16             	shr    $0x16,%ecx
  if(*pde & PTE_P){
801076be:	8b 14 8a             	mov    (%edx,%ecx,4),%edx
801076c1:	f6 c2 01             	test   $0x1,%dl
801076c4:	0f 84 f8 00 00 00    	je     801077c2 <uva2ka.cold>
  return &pgtab[PTX(va)];
801076ca:	c1 e8 0c             	shr    $0xc,%eax
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
801076cd:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  if((*pte & PTE_P) == 0)
    return 0;
  if((*pte & PTE_U) == 0)
    return 0;
...
801076d3:	5d                   	pop    %ebp
  return &pgtab[PTX(va)];
801076d4:	25 ff 03 00 00       	and    $0x3ff,%eax
  if((*pte & PTE_P) == 0)
801076d9:	8b 94 82 00 00 00 80 	mov    -0x80000000(%edx,%eax,4),%edx
  return (char*)P2V(PTE_ADDR(*pte));
801076e0:	89 d0                	mov    %edx,%eax
801076e2:	f7 d2                	not    %edx
801076e4:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801076e9:	05 00 00 00 80       	add    $0x80000000,%eax
801076ee:	83 e2 05             	and    $0x5,%edx
801076f1:	ba 00 00 00 00       	mov    $0x0,%edx
801076f6:	0f 45 c2             	cmovne %edx,%eax
}
801076f9:	c3                   	ret
...
80107709:	8b 75 14             	mov    0x14(%ebp),%esi
8010770c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010770f:	8b 55 10             	mov    0x10(%ebp),%edx
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
  while(len > 0){
80107712:	85 f6                	test   %esi,%esi
80107714:	75 51                	jne    80107767 <copyout+0x67>
80107716:	e9 9d 00 00 00       	jmp    801077b8 <copyout+0xb8>
8010771b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
  return (char*)P2V(PTE_ADDR(*pte));
80107720:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
80107726:	8d 8b 00 00 00 80    	lea    -0x80000000(%ebx),%ecx
    va0 = (uint)PGROUNDDOWN(va);
    pa0 = uva2ka(pgdir, (char*)va0);
    if(pa0 == 0)
8010772c:	81 fb 00 00 00 80    	cmp    $0x80000000,%ebx
80107732:	74 74                	je     801077a8 <copyout+0xa8>
      return -1;
    n = PGSIZE - (va - va0);
80107734:	89 fb                	mov    %edi,%ebx
80107736:	29 c3                	sub    %eax,%ebx
80107738:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if(n > len)
8010773e:	39 f3                	cmp    %esi,%ebx
80107740:	0f 47 de             	cmova  %esi,%ebx
      n = len;
    memmove(pa0 + (va - va0), buf, n);
80107743:	29 f8                	sub    %edi,%eax
80107745:	83 ec 04             	sub    $0x4,%esp
80107748:	01 c1                	add    %eax,%ecx
8010774a:	53                   	push   %ebx
8010774b:	52                   	push   %edx
8010774c:	89 55 10             	mov    %edx,0x10(%ebp)
8010774f:	51                   	push   %ecx
80107750:	e8 1b d5 ff ff       	call   80104c70 <memmove>
    len -= n;
    buf += n;
80107755:	8b 55 10             	mov    0x10(%ebp),%edx
    va = va0 + PGSIZE;
80107758:	8d 87 00 10 00 00    	lea    0x1000(%edi),%eax
  while(len > 0){
8010775e:	83 c4 10             	add    $0x10,%esp
    buf += n;
80107761:	01 da                	add    %ebx,%edx
  while(len > 0){
80107763:	29 de                	sub    %ebx,%esi
80107765:	74 51                	je     801077b8 <copyout+0xb8>
  if(*pde & PTE_P){
80107767:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pde = &pgdir[PDX(va)];
8010776a:	89 c1                	mov    %eax,%ecx
    va0 = (uint)PGROUNDDOWN(va);
8010776c:	89 c7                	mov    %eax,%edi
  pde = &pgdir[PDX(va)];
8010776e:	c1 e9 16             	shr    $0x16,%ecx
    va0 = (uint)PGROUNDDOWN(va);
80107771:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
  if(*pde & PTE_P){
80107777:	8b 0c 8b             	mov    (%ebx,%ecx,4),%ecx
8010777a:	f6 c1 01             	test   $0x1,%cl
8010777d:	0f 84 46 00 00 00    	je     801077c9 <copyout.cold>
  return &pgtab[PTX(va)];
80107783:	89 fb                	mov    %edi,%ebx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80107785:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
  return &pgtab[PTX(va)];
8010778b:	c1 eb 0c             	shr    $0xc,%ebx
8010778e:	81 e3 ff 03 00 00    	and    $0x3ff,%ebx
  if((*pte & PTE_P) == 0)
80107794:	8b 9c 99 00 00 00 80 	mov    -0x80000000(%ecx,%ebx,4),%ebx
  if((*pte & PTE_U) == 0)
8010779b:	89 d9                	mov    %ebx,%ecx
8010779d:	f7 d1                	not    %ecx
8010779f:	83 e1 05             	and    $0x5,%ecx
801077a2:	0f 84 78 ff ff ff    	je     80107720 <copyout+0x20>
  }
  return 0;
}
...
801077c2 <uva2ka.cold>:
  if((*pte & PTE_P) == 0)
801077c2:	a1 00 00 00 00       	mov    0x0,%eax
801077c7:	0f 0b                	ud2

801077c9 <copyout.cold>:
801077c9:	a1 00 00 00 00       	mov    0x0,%eax
801077ce:	0f 0b                	ud2
